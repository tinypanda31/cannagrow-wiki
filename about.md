...
|-----------|-------------|
| **Neutrality** | We present information without advocating for or against cannabis use. We describe what is known without prescribing what should be done. |
| **Evidence-Based** | Claims are grounded in peer-reviewed research, historical documentation, or transparently attributed expert sources. Speculation is clearly labeled. |
| **Accessibility** | All content is free to read and designed to be understandable by non-specialists while remaining accurate enough for professionals. |
...
3. **No promotion of illegal activity** — CannaGrow describes cannabis-related topics educationally. It does not instruct, encourage, or facilitate illegal conduct under any jurisdiction's laws.
...
Some images, data tables, or quoted material on CannaGrow may be sourced from third parties under different licenses or under fair use provisions. Each such item is attributed at the point of use.

---

## Community Standards

CannaGrow is committed to maintaining a respectful, productive environment for all participants.

### Code of Conduct

- Treat all contributors and readers with respect, regardless of their views on cannabis
- Critique content, not people
- Assume good faith in editorial disagreements
- Do not harass, intimidate, or discriminate against any individual
- Keep discussions focused on improving content quality

### Conflict Resolution

1. Discuss disagreements directly with the involved contributor on their talk page
2. If unresolved, request input from a neutral editor
3. For persistent issues, contact an administrator
