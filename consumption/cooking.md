...
description: A practical home guide to decarboxylation, infusing butter and oil, dosing calculations, recipe substitution, and a classic infused brownie recipe for safe home preparation.
tags: consumption, edibles, decarboxylation, cannabutter, infused-oil, cooking, dosing, recipes
---
...
![Cannabis-infused butter and oil preparation](/uploads/images/consumption/cooking-cannabis.jpg)
...
### Home Decarboxylation Method (Oven)
...
### Decarboxylation Quick Reference
...
1. **Melt** — Combine butter and water in a saucepan over low heat. Heat until the butter is fully melted.
2. **Add cannabis** — Stir in the decarboxylated cannabis.
3. **Simmer** — Maintain the temperature at **160-200°F (71-93°C)** for **2-4 hours**, stirring occasionally. The mixture should barely simmer — never boil. Use a thermometer to monitor.
4. **Strain** — Place cheesecloth over a fine-mesh strainer set above a bowl or jar. Pour the mixture through the cloth. Gather the cloth edges and squeeze firmly to extract all infused butter.
5. **Separate** — The water and butter will separate in the container. Refrigerate until the butter solidifies on top (2-4 hours).
6. **Store** — Remove the solidified butter disc from the water underneath. Discard the water. Store cannabutter in an airtight container in the refrigerator (3-4 weeks) or freezer (6-12 months).
...
**What You Need:**
- Decarboxylated cannabis
- Coconut oil (or olive oil, MCT oil)
- Saucepan or slow cooker
- Cheesecloth
- Fine-mesh strainer
...
1. **Melt** — Warm the coconut oil in a saucepan over low heat until liquid (if solid).
2. **Add cannabis** — Stir in the decarboxylated cannabis.
3. **Infuse** — Maintain **160-200°F (71-93°C)** for **2-4 hours**, stirring occasionally.
4. **Strain** — Pour through cheesecloth and fine-mesh strainer. Squeeze the plant material firmly.
5. **Store** — Transfer to an airtight container. Coconut oil solidifies below 76°F (24°C). Store at room temperature (1-2 months), refrigerated (3-6 months), or frozen (12+ months).
...
### Worked Example: Cannabutter Brownies
...
### Recipes to Avoid for Beginners
...
## Recipe: Classic Cannabis Brownies
...
- [ ] Cannabis was properly decarboxylated (golden-brown, not green or black)
- [ ] Dosing calculations were completed and written down
- [ ] Each piece is labeled with estimated THC content
- [ ] Stored in child-proof, pet-proof containers
- [ ] Clearly marked as containing cannabis (not regular food)
- [ ] First serving is a small piece (start with half or quarter of a standard portion)
- [ ] You have at least 4 hours available (effects last 4-12 hours)
- [ ] You are in a comfortable, safe environment
- [ ] You have not consumed alcohol or other substances

---

## Related Pages

- **[Edibles Guide](/consumption/edibles/index)** — How edibles work, 11-hydroxy-THC metabolism, commercial product types, and safety
- **[Decarboxylation Science](/science/decarboxylation)** — Detailed chemistry of THCA to THC conversion
- **[Tinctures](/consumption/tinctures/index)** — Liquid alternative to edibles with precise dosing
- **[Cannabinoids](/science/cannabinoids)** — THC, CBD, and the endocannabinoid system
- **[Harm Reduction](/legal-safety/harm-reduction)** — Comprehensive safety guidance

---

> **See Also:** [/consumption/edibles](/consumption/edibles/index) | [/consumption/tinctures](/consumption/tinctures/index) | [/science/decarboxylation](/science/decarboxylation) | [/science/cannabinoids](/science/cannabinoids) | [/legal-safety/harm-reduction](/legal-safety/harm-reduction)