---
title: "Dabbing"
description: "Educational guide to dabbing cannabis concentrates -- equipment, technique, temperatures, safety, and harm reduction."
---
...
![Dab rig setup with banger and torch](/uploads/images/consumption/dabbing.jpg)
...
The process:
1. The nail or banger is heated to 315-700 degrees F (157-371 degrees C) using a butane torch or electronic heating element (e-nail)
2. The concentrate is applied to the hot surface using a dab tool
3. The concentrate instantly vaporizes
4. A carb cap is placed over the banger to control airflow and maintain temperature
5. The vapor is drawn through the rig's water chamber and inhaled
...
- Ensure the dab rig is clean and contains an appropriate amount of water (enough to submerge the downstem by approximately 0.5-1 inch)
- Attach the banger or nail securely

**Step 2: Heat the Banger**
- Using a butane torch, heat the banger evenly until it reaches the desired temperature
- For quartz bangers, heat until just below red-hot for medium-temp dabs, or less for low-temp dabs
- With an e-nail, simply set the desired temperature and wait for it to reach it

**Step 3: Prepare the Dab**
- Use the dab tool to pick up a small amount of concentrate (start with a dab the size of a grain of rice or smaller)
- Have the carb cap ready

**Step 4: Apply the Dab**
- Place the concentrate onto the hot banger
- Immediately place the carb cap over the banger
- Inhale slowly and steadily through the mouthpiece
- The concentrate will vaporize; control the airflow with the carb cap (rotate or partially lift to adjust)

**Step 5: Clear the Rig**
- Once all vapor has been produced, remove the carb cap and inhale to clear the rig of remaining vapor

**Step 6: Clean Up (Optional but Recommended)**
- While the banger is still warm, use a cotton swab (Q-tip) to wipe away any remaining residue
- This is called a "q-tip terp" and captures the last flavorful vapor
- Regular cleaning maintains flavor and efficiency
...
1. **Start with a TINY amount** -- A dab the size of a grain of rice or smaller is sufficient. You can always take more, but you cannot take less.
2. **Use lower temperatures** -- 400-500 degrees F (204-260 degrees C) provides a smoother experience and better flavor.
3. **Have a sober sitter** -- Especially for your first few sessions, having someone experienced present is valuable.
4. **Choose quality concentrates** -- Only dab concentrates from licensed, tested sources. Unknown concentrates may contain harmful contaminants.
5. **Don't mix with other substances** -- Avoid combining dabbing with alcohol or other drugs.
6. **Be prepared for intensity** -- The effects are rapid and strong. If you feel uncomfortable, focus on slow, deep breathing and remind yourself that the effects will pass.
7. **Have CBD available** -- CBD can help modulate THC effects. If a dab is too intense, consuming CBD (tincture, flower, or edible) may help reduce discomfort.
8. **Stay hydrated** -- Keep water nearby.
9. **Don't drive** -- Do not drive or operate machinery for several hours after dabbing.

### What to Do If You Consume Too Much

1. **Don't panic** -- No one has ever died from a cannabis overdose. The experience is uncomfortable but not physically dangerous for healthy adults.
2. **Find a quiet, comfortable place** -- Sit or lie down in a familiar, safe environment
3. **Breathe slowly and deeply** -- Deep breathing helps manage anxiety
4. **Stay hydrated** -- Drink water
5. **Try black pepper** -- Chewing on a few black peppercorns or sniffing ground pepper may help reduce anxiety (terpene caryophyllene interacts with CB2 receptors)
6. **Use CBD** -- If available, CBD can help counteract THC intensity
7. **Wait it out** -- Peak effects will subside within 30-60 minutes; residual effects may last longer
8. **Seek medical attention if needed** -- If you experience severe symptoms (chest pain, severe vomiting, extreme anxiety that does not subside), seek medical help
...
## Quality Concerns with Concentrates
