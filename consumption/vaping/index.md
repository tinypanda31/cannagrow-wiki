---
title: "Vaporizing"
description: "Educational overview of cannabis vaporization -- dry herb and concentrate vaporizers, temperature guides, and safety considerations."
---
...
- **Above the vaporization point** of cannabinoids (THC vaporizes at approximately 314 degrees F / 157 degrees C) and terpenes (most vaporize between 310-390 degrees F / 154-199 degrees C)
- **Below the combustion point** of plant material (approximately 446 degrees F / 230 degrees C and above)

At these temperatures:
1. **Cannabinoids are released as vapor** -- THC, CBD, and other compounds transition from solid/liquid to vapor
2. **Terpenes are released as aromatic vapor** -- The full flavor profile is available without burning
3. **No combustion occurs** -- No smoke, tar, or carbon monoxide is produced
4. **Vapor is inhaled** -- Cannabinoids are absorbed through the lungs into the bloodstream
...
1. **Buy licensed** -- Only purchase from licensed dispensaries in legal markets
2. **Check lab results** -- Verify that the product has been tested for residual solvents, pesticides, heavy metals, and cutting agents
3. **Avoid street cartridges** -- Illicit market cartridges have unknown contents
4. **Check hardware quality** -- Quality cartridges use ceramic or stainless steel heating elements, not cheap metals
5. **Store properly** -- Keep cartridges upright in a cool, dark place
6. **Use correct voltage** -- Follow manufacturer recommendations for battery voltage (typically 2.0-3.3V for cartridges)
...
- **Reduced toxin exposure:** Studies comparing cannabis vapor to smoke consistently show significantly lower levels of carbon monoxide, tar, benzene, and other harmful compounds in vapor
- **Respiratory effects:** Vaporizing is generally less irritating to the respiratory system than smoking, though long-term studies on vaporizing specifically are still limited
- **Efficiency:** Research confirms that vaporizing delivers cannabinoids more efficiently than smoking, with approximately 46% bioavailability compared to 25-30% for smoking

### Limitations of Current Knowledge

- Long-term health effects of regular cannabis vaporizing have not been studied as extensively as smoking
- The safety of vaporizer materials (heating elements, plastics, adhesives) under repeated heating cycles is not fully characterized
- Additives and cutting agents in some cartridges introduce variables not present in dry herb vaporizing
