---
title: Curing & Storage
description: A complete guide to the cannabis curing process, jar curing method, monitoring humidity, troubleshooting, and long-term storage best practices for preserving potency and terpenes.
---
...
![Glass jars of curing cannabis with hygrometers and humidity packs](/uploads/images/cultivation/curing-storage.jpg)
...
### Step-by-Step Jar Curing

**Step 1: Confirm dryness is adequate**

Before jarring, buds must pass the stem snap test (see [/cultivation/harvest-dry](/cultivation/harvest-dry)). Small stems should snap cleanly when bent. If stems still bend, drying is incomplete.

**Step 2: Trim and jar**

1. Trim buds to your preference (final trim if not done during harvest)
2. Fill glass jars 65-75% full (do not pack tightly)
3. Place a mini hygrometer inside one jar per batch
4. Optionally add a 62% Boveda or Integra humidity pack
5. Seal the lid
...
1. Place a small amount of table salt on a bottle cap or piece of foil
2. Add a few drops of water to make a wet slurry (not dissolved)
3. Place the hygrometer and the salt in a sealed zip-lock bag or small container
4. Wait 6-8 hours
5. The hygrometer should read exactly **75% RH**
6. If it reads differently, note the offset and adjust readings accordingly (or adjust the calibration screw if the unit has one)
...
### Humidity Packs: Boveda vs. Integra
...
1. **Ensure buds are properly cured** -- Do not vacuum seal uncured or improperly cured cannabis
2. **Confirm correct moisture** -- 58-62% RH; add a small Boveda pack inside the bag if possible
3. **Use vacuum sealer with pulse/manual mode** -- Gentlest setting to avoid crushing buds
4. **Partially seal** -- Stop vacuuming when buds begin to compress slightly (do not fully crush)
5. **Store in a cool, dark place** -- Or freeze for maximum preservation
...
**When to freeze:**
- Large harvests that cannot all be jar-cured at once
- Long-term storage (1+ years)
- Preservation of specific genetics for future use

**When not to freeze:**
- Cannabis intended for consumption within 6 months
- Display or regular-access storage
- Uncured cannabis (must be fully dried first)

## Preserving Potency and Terpenes
...
- [ ] **Complete curing** -- Minimum 2 weeks; ideally 4-8 weeks
- [ ] **Final inspection** -- Check for any mold, off-odors, or moisture issues
- [ ] **Select containers** -- Glass jars for regular access; Mylar/vacuum for long-term
- [ ] **Add humidity packs** -- 58% or 62% Boveda/Integra in each container
- [ ] **Minimize headspace** -- Fill containers adequately to reduce oxygen volume
- [ ] **Label containers** -- Strain name, harvest date, curing start date, storage date
- [ ] **Choose storage location** -- Cool (60-70°F), dark, dry, consistent temperature
- [ ] **Monitor periodically** -- Check humidity packs monthly; replace when hardened
- [ ] **Minimize opening** -- Each exposure introduces oxygen; take only what you need
