---
title: Cannabis Containers and Growing Media
description: A buyer's guide to cannabis grow containers and growing media — fabric pots, air pots, smart pots, RDWC systems, soil, coco coir, perlite, amendments, and root zone management.
tags: cultivation, equipment, containers, fabric-pots, air-pots, coco, soil, RDWC, growing-medium, root-zone
---
...
# Cannabis Containers and Growing Media
...
**Key benefits:**
- Superior air pruning leads to healthier root architecture and better nutrient uptake.
- Excellent drainage prevents overwatering—the most common beginner mistake.
- Lightweight and collapsible for easy storage between grows.
- Available in sizes from 1 gallon to 200+ gallons.
...
**Key benefits:**
- Maximum air pruning—the most aggressive root branching of any container type.
- Indefinite lifespan—rigid HDPE plastic can be reused for dozens of cycles.
- Stackable for storage when not in use.
- Excellent for mother plants and long-term vegetative plants where root health is critical.

**When the premium cost is justified:**
- **Mother plants** kept in veg for months or years benefit enormously from the superior root structure.
- **Performance-focused indoor grows** where every percentage point of yield and terpene production matters.
- **Hot climates** where fabric pots would dry out too quickly—the solid walls retain moisture better while the bottom holes still provide drainage and air pruning.
- **Commercial operations** that need containers lasting 10+ cycles to reduce replacement costs.
...
- **Seedlings and clones:** Small 1–2 gallon plastic pots are perfect for early-stage plants. The slower drying gives young roots time to establish.
- **Hydroponic net cups:** 2-inch and 3-inch net cups for DWC and RDWC are necessarily plastic.
- **Budget grows:** If you are starting out and money is tight, a 5-gallon bucket from the hardware store (food-grade, drilled with drainage holes) works perfectly well.
- **Short-term grows:** Autoflower grows that last 8–10 weeks from seed to harvest do not benefit as much from air pruning since the plant lifecycle is too short for roots to become significantly root-bound.
...
## Transplanting: When and How Big
...
### The Transplant Ladder

A typical photoperiod transplant progression looks like this:

1. **Seedling cup / rockwool cube** (0.5–1 gallon) — germination through first true leaf sets, approximately 7–14 days.
2. **1 gallon pot** — early vegetative stage, approximately 7–10 days. Roots should be visible at the edges of the root ball.
3. **3–5 gallon pot** — mid vegetative stage, approximately 10–14 days. Plant should have 4–6 nodes.
4. **7–10 gallon pot** — late vegetative / pre-flower transition. Plant should be well-established with a strong stem.
5. **15–20+ gallon pot** (optional, for large plants) — final container for plants expected to exceed 5 feet.
...
- **Roots visible at drainage holes** or circling the surface of the medium.
- **Root ball holds its shape** when gently removed from the pot—this indicates the roots have colonized the available space.
- **The plant drinks daily or near-daily**, indicating the root mass is large enough to demand frequent water.
- **Healthy vegetative growth** with multiple nodes and strong stem caliper.
...
1. **Water the plant lightly** 1–2 hours before transplanting—moist roots hold together better than dry roots.
2. **Prepare the new pot** with pre-moistened medium. Do not pack it down; keep it fluffy.
3. **Gently remove the plant** by squeezing the sides of the flexible pot or inverting and supporting the stem. Never pull by the stem.
4. **Place in the new pot** at the same soil line depth. Burying the stem deeper can work for tomatoes but is unnecessary for cannabis.
5. **Fill around the root ball** with fresh medium. Tap the pot gently to settle—do not compress.
6. **Water with a light nutrient solution** or plain pH-adjusted water. Adding mycorrhizae at this stage (if not already applied) helps the roots colonize the new medium.
7. **Keep under moderate light** for 24–48 hours to reduce stress, then return to full vegetative light.

### Signs of Root-Bound Plants

- Roots growing out of drainage holes in thick mats.
- Roots circling the surface of the medium visibly.
- Plant wilts between waterings even with frequent watering.
- Growth rate slows despite adequate light, nutrients, and environment.
- The root ball is a solid mass with no visible medium when removed from the pot.
...
- **Scalable**—add more buckets to the system as needed.

**Cons of RDWC:**
- **High initial cost**—a quality 4-bucket RDWC system costs $300–$800+.
- **Complexity**—plumbing leaks, pump failures, and clogged lines are real risks.
- **Pathogen spread**—if root rot (Pythium) enters one bucket, it circulates to all buckets quickly.
- **Power dependency**—if the air pump or circulation pump fails, plants can decline within hours.
- **Steep learning curve**—not recommended for first-time growers. Master soil or coco first.

### RDWC System Components
...
**3. Plumbing layout:** 
- **Supply line:** Run a main supply line from the reservoir pump to each bucket. Use 1/2-inch or 3/4-inch tubing. Branch to each bucket with a tee fitting. Install a ball valve or flow restrictor on each branch to balance flow between buckets.
- **Return/drain line:** Each bucket drains back to the reservoir via gravity. Use 3/4-inch or 1-inch tubing for the return line to prevent backup. Ensure the drain outlet in each bucket is higher than the medium level to keep roots from sitting in stagnant water.
- **Equalization:** Some systems use an equalization line connecting the bottom of all buckets to keep water levels uniform. This is optional but recommended for beginners.
...
**Pros:**
- **Forgiving of mistakes**—soil buffers pH swings and nutrient imbalances better than any other medium.
- **Less frequent watering**—soil holds water longer, meaning you can water every 2–4 days instead of daily.
- **Supports living soil builds**—when done right, living soil produces unmatched terpene profiles and flavor.
- **Organic cultivation possible**—with super soil, you can grow an entire cycle with plain water only.

**Cons:**
- **Slower growth rates** than hydroponic or coco systems due to lower oxygen levels and slower nutrient availability.
- **Heavy**—quality soil is dense and difficult to move in large quantities.
- **Pest risk**—organic soil can harbor fungus gnats, root aphids, and other soil-dwelling pests.
- **Variable quality**—cheap soils contain composted bark and virtually no nutrients. Always use soil formulated for cannabis or vegetables.
...
**Pros:**
- **Fast growth rates**—comparable to hydroponic systems while still being a drain-to-waste medium.
...
- **Requires buffering**—raw coco contains excess potassium and sodium from the coconut processing. Quality pre-buffered coco (like Canna Coco) is ready to use. Unbuffered coco must be soaked in Cal-Mag solution before use.
- **Narrower pH window**—coco performs best at pH 5.5–6.2, which is tighter than soil's 6.0–7.0 range.
- **Daily watering preferred**—while coco can handle infrequent watering, it performs best with daily or twice-daily watering to maintain consistent moisture.

**The buffering process (for unbuffered coco):**
1. Soak the coco brick in a large container with pH 5.5 water containing 200–300 ppm Cal-Mag.
2. Let it expand and hydrate for 6–8 hours.
3. Drain and rinse thoroughly with pH 5.5 water.
4. Repeat the soak-and-rinse process 2–3 times until the runoff Cal-Mag ppm stabilizes.
5. Mix with 30% perlite for optimal drainage.
6. The coco is now buffered and ready to use.
...
**Common additions:**
- **Perlite** (already in most mixes, but can be added): 10–30% extra for improved drainage.
- **Mycorrhizae** (in Pro-Mix BX): Beneficial root fungi that improve nutrient uptake.
- **Limestone** (in some mixes): Added to adjust the naturally acidic pH of peat moss.
...
## Medium Additives and Amendments
...
## Root Zone Management by Medium
...
- [Equipment Overview](/cultivation/equipment/index) — Full equipment guide for indoor and outdoor grows
- [Advanced Cultivation Techniques](/cultivation/advanced-techniques) — Air pruning, root pruning, mycorrhizal inoculation, and no-till methods
- [Nutrients and Feeding](/cultivation/nutrients/index) — Medium-specific feeding strategies for soil, coco, and hydroponic systems
- [Indoor Grow Guide](/cultivation/indoor/grow-guide) — Complete indoor cultivation from setup to harvest
- [Hydroponics](/cultivation/indoor/hydroponics) — DWC, ebb and flow, drip systems, and nutrient film technique
- [Troubleshooting Guide](/cultivation/troubleshooting) — Root zone problems, nutrient deficiencies, and pest management

---

> **See Also:** [/cultivation/equipment/index](/cultivation/equipment/index) | [/cultivation/advanced-techniques](/cultivation/advanced-techniques) | [/cultivation/nutrients](/cultivation/nutrients/index) | [/cultivation/indoor/hydroponics](/cultivation/indoor/hydroponics) | [/cultivation/indoor/grow-guide](/cultivation/indoor/grow-guide) | [/cultivation/troubleshooting](/cultivation/troubleshooting)
