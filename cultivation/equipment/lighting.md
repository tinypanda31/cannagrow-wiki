---
title: Cannabis Lighting Equipment
description: A buyer's guide to cannabis grow lighting — LED vs HPS vs CMH purchasing decisions, brand comparisons by budget tier, light footprint sizing, heat management, and accessory selection.
tags: cultivation, equipment, lighting, LED, HPS, CMH, purchasing, heat-management, accessories
---
...
> **Note:** For the science of lighting (PPFD, DLI, PAR spectrum, light cycles), see the complete [Lighting Systems](/cultivation/indoor/lighting) guide.

## Technology Comparison: What to Buy
...
- Lowest electricity cost per gram of yield
- Minimal heat output reduces ventilation and AC requirements
- Full-spectrum options optimized for cannabis
- Long lifespan — often outlasts the grow space itself
- Dimmable on most quality units
- No ballast or bulb replacements needed
- Can run lights closer to canopy (12-24 inches)

**Cons:**

- Higher upfront cost than HPS
- Extremely crowded market with many low-quality products
- Marketing claims are frequently inflated ("1000W equivalent" may actually draw 100W)
- Cheap units may use no-name diodes that degrade rapidly

**What to look for when buying:**

- **Diode brand:** Samsung LM301H or LM301H EVO diodes are the gold standard for horticultural LEDs. Samsung LM301B is an acceptable budget alternative. Bridgelux diodes are also reputable but less common in cannabis-specific fixtures.
- **Driver brand:** Mean Well is the industry standard driver manufacturer. A light using genuine Mean Well drivers is a strong quality signal. Inventronics drivers are also excellent.
- **Bar-style vs. quantum board vs. COB:** Bar-style (multiple LED strips across a frame) provides the most even light distribution and is preferred for most rectangular grow spaces. Quantum boards (single large panel) work well in small square tents. COB (chip-on-board) units are less common now and tend to create hotspot issues.
- **Actual watt draw:** Always verify the actual power draw from the wall, not the "equivalent" or "replace 1000W HPS" marketing number. A quality 600W LED bar light is sufficient for a 4x4 space.
- **Spectrum:** Look for a spectrum that includes white diodes (3000K-3500K for flowering, 5000K for vegetative) plus some red (660nm) and optionally UV diodes. Full-spectrum white LEDs with added red is the current best practice.
- **Dimming:** A dimmer knob or controller is essential for seedling/clone stages and light stress management.
- **Certifications:** Look for UL, ETL, or DLC certification. These indicate the unit has been independently tested for safety and performance.
...
- Lowest upfront cost per watt of light output
- Proven track record — decades of successful grows
- Excellent penetration through dense canopy
- Bulbs and ballasts are commodity items, widely available
- Strong red spectrum is ideal for flowering

**Cons:**

- Very high heat output — requires serious ventilation
- High electricity costs
- Bulbs degrade over time and must be replaced every 1-2 grows
- Spectrum is heavily skewed toward red/orange with weak blue — plants stretch more
- Requires a separate ballast
- Must be hung 18-36 inches from canopy due to heat
- Shorter overall lifespan

**When it still makes sense:**

- Tight budget builds where upfront cost is the primary constraint
- Cold climate grows where the extra heat is beneficial
- Supplemental flowering light in greenhouses
- Large commercial operations already tooled up for HPS
...
- Excellent full-spectrum output with high UVB content — can increase terpene and resin production
- More efficient than HPS (better umol/J)
- Significantly less heat than HPS of equivalent wattage
- Good light penetration
- Longer bulb life than HPS
- Single-ended bulbs are simpler to replace

**Cons:**

- Higher upfront cost than HPS
- Bulbs are more expensive than HPS bulbs ($30-50 each)
- Lower total light output than equivalently sized HPS
- Not as efficient as quality LED
- Fewer product options on the market
- Some units produce RF interference that can disrupt WiFi and controllers
...
- Rooting clones
- Small mother plant maintenance
- Micro grows (single plant in very small space)
...
- **Target wattage per square foot:** Aim for 30-50 actual watts per square foot for flowering cannabis with LED. For HPS, use 50-75 watts per square foot due to lower efficiency.
- **Actual draw vs. "equivalent":** Ignore "equivalent wattage" marketing entirely. A light advertised as "1000W equivalent" may draw only 100W from the wall. Always find the actual power draw specification. It should be listed as "actual watt draw," "power consumption," or "wall draw."
- **The 1-watt-per-sq-inch rule:** An old HPS-era guideline suggesting 50-75W per square foot. Still roughly applicable for HPS but LEDs achieve the same results with 30-50W per square foot due to higher efficiency.
...
- "Equivalent" wattage listed but no actual draw specification
- No diode brand mentioned (if they use Samsung diodes, they will advertise it)
- No driver brand mentioned
- Blurple (red/blue only) spectrum — this is outdated technology
- Spectrum charts that look obviously fabricated
- No warranty or a warranty shorter than 1 year
- Reviews that appear generic or duplicated
- Seller cannot provide independent PPFD data

## What to Look for When Buying

Use this checklist before purchasing any grow light:

- [ ] **Actual watt draw** is clearly specified (not just "equivalent" wattage)
- [ ] **Diode brand** is named — Samsung LM301H/H EVO preferred, LM301B acceptable, Bridgelux acceptable
- [ ] **Driver quality** — Mean Well or Inventronics preferred; generic drivers are a cost-cutting indicator
- [ ] **Spectral range** includes full-spectrum white (3000K-5000K) with supplemental red (660nm); UV is a bonus
- [ ] **Coverage area** matches your grow space — check the manufacturer's recommended coverage for flowering, not just vegetative
- [ ] **Warranty** is at least 2 years; 5 years indicates manufacturer confidence
- [ ] **Certifications** — UL, ETL, or DLC listing indicates independent safety and performance testing
- [ ] **Independent PPFD maps** available from third-party reviewers (not just manufacturer data)
- [ ] **Dimming capability** is included
- [ ] **Daisy-chain capability** if you plan to run multiple lights from one controller
- [ ] **Build quality** — thick aluminum heat sink, quality solder work visible in product photos, secure driver mounting
- [ ] **Fan noise** — check reviews for fan noise complaints; some LED drivers use active cooling fans that can be loud in small spaces
- [ ] **Return policy** — ensure you can return the light if PPFD or coverage does not meet your needs
...
### Light Movers: Pros and Cons

Light movers move your grow light across the canopy, either in a linear track or circular pattern.

**Pros:**

- More even light distribution — reduces hot spots and shaded areas
- Allows lights to be hung closer to canopy since no single spot receives continuous maximum intensity
- Can reduce the number of lights needed for a given space by 20-30%
- Mimics natural sun movement
- May improve bud development across the entire canopy

**Cons:**

- Additional cost ($40-150) and another component that can fail
- Adds complexity to the grow setup
- Not all light fixtures are compatible — check weight ratings
- Minimal benefit with modern high-quality LED bar lights that already provide even coverage
- Can be noisy if the motor is cheap
...
- **LED in a tent:** A 4-inch inline fan (100-200 CFM) is typically sufficient for a 4x4 tent with a 500W LED.
- **HPS in a tent:** A 6-inch inline fan (400+ CFM) is recommended for a 4x4 tent with a 600W HPS.
- **Air-cooled hoods:** HPS and CMH lights can be placed in air-cooled glass hoods that vent heat directly from the bulb. This removes 40-60% of the heat before it enters the grow space but reduces light output by 5-10%.
- **AC sizing:** As a rough estimate, a 10x10 room with a 600W HPS may need a 5,000-8,000 BTU AC unit. The same room with a 500W LED may need only 3,000-5,000 BTU. These are rough estimates — actual requirements depend on insulation, ambient temperature, and other equipment heat.

### Ducting and Exhaust Setup

- Always exhaust heat from the top of the grow space or tent (heat rises)
- Use insulated ducting if running exhaust through unconditioned spaces
- Carbon filters should be placed inside the grow space, before the exhaust fan, to filter odor before air leaves the space
- Negative pressure (slightly more exhaust than intake) prevents odor leakage
...
### When Supplemental Lighting is Needed

- **DLI below 25 mol/m²/day:** If your greenhouse does not consistently deliver a daily light integral of at least 25 mol/m²/day, supplemental lighting will improve yield and quality. This is common in northern latitudes during fall, winter, and early spring.
- **Photoperiod control:** Cannabis is a short-day plant that requires 12 hours of darkness to flower. In spring and summer, natural day length may exceed 14 hours, preventing flowering. Blackout curtains solve this — but supplemental lighting is needed if you want to grow vegetative plants during short winter days.
- **Seedling and clone area:** Even in summer, greenhouse light may be too intense for seedlings. Conversely, winter greenhouse light may be too weak. Supplemental LED bars at low power are ideal.

### Supplemental Light Types for Greenhouses
...
- **Spring/Summer:** Natural light is usually sufficient. Focus on shading and heat management. Blackout may be needed to force flowering.
- **Fall:** Natural DLI drops rapidly in northern latitudes. Supplemental lighting becomes valuable for flowering plants started in late summer.
- **Winter:** In most non-tropical locations, natural light is insufficient for flowering cannabis. Supplemental lighting is essential if growing through winter. The low ambient temperatures combined with LED heat can actually be advantageous.
...
- [Lighting Systems (Science)](/cultivation/indoor/lighting) — PPFD, DLI, PAR spectrum, light cycles
- [Environmental Control Equipment](/cultivation/equipment/environment) — Managing heat from lights
- [Indoor Grow Guide](/cultivation/indoor/grow-guide)
- [Greenhouse Cultivation](/cultivation/greenhouse/index)
- [Equipment Overview](/cultivation/equipment/index)

---

> **See Also:** [/cultivation/indoor/lighting](/cultivation/indoor/lighting) | [/cultivation/equipment/environment](/cultivation/equipment/environment) | [/cultivation/equipment/index](/cultivation/equipment/index) | [/cultivation/indoor/grow-guide](/cultivation/indoor/grow-guide) | [/cultivation/greenhouse](/cultivation/greenhouse/index)
