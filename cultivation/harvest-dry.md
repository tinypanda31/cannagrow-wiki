...
description: A guide to harvesting cannabis at the right time, trimming, drying fundamentals, environment setup, and avoiding common mistakes that compromise quality.
---
...
![Harvested cannabis branches ready for drying](/uploads/images/cultivation/harvest-dry.jpg)
...
![Trichome progression from clear to cloudy to amber](/uploads/images/cultivation/trichome-maturity.jpg)
...
1. **Obtain a magnification tool** -- A jeweler's loupe (30x-60x), USB microscope, or pocket microscope
2. **Select sample buds** -- Examine buds from different parts of the plant (top colas mature fastest)
3. **Focus on the calyxes** (the flower structures), not the sugar leaves (sugar leaves mature faster and show amber earlier)
4. **Observe the mushroom-shaped gland heads** -- Note the color distribution
5. **Record findings** -- Take photos for reference; track progression over days
...
### Alternative Harvest Indicators
...
**Steps:**
1. Cut the main stem at the base (near soil level)
2. Remove large fan leaves by hand (they can be saved for extraction)
3. Hang the entire plant upside down on a line or hanger
4. Trim after drying (dry trim)

**Pros:**
- Slower, more even drying (branches insulate inner buds)
- Less handling of wet buds (reduces trichome loss)
- Simpler workflow

**Cons:**
- Requires more drying space
- Trimming is more difficult after drying
- Less airflow between branches during drying
...
**Steps:**
1. Remove large fan leaves
2. Cut the plant into manageable branches (6-12 inches long)
3. Optionally trim sugar leaves (wet trim) or leave them on (dry trim)
4. Hang branches individually on drying lines or hangers

**Pros:**
- Manageable pieces; easier to handle
- Flexible trimming approach (wet or dry trim)
- Fits standard drying spaces

**Cons:**
- More handling of plant material
- Branches dry faster than whole plants
- More decisions to make during harvest

**Best for:** Most home growers; standard drying setups.

## Trimming: Wet vs. Dry Trim
...
1. **Remove large fan leaves** -- Pull or cut the obvious large leaves first
2. **Trim sugar leaves** -- Cut the small, resin-coated leaves close to the bud
   - Some growers leave a small portion of sugar leaves to protect buds during drying
3. **Shape the bud** -- Remove any small, wispy growth ("popcorn" buds) from the interior
4. **Handle gently** -- Minimize contact with flower surfaces to preserve trichomes
5. **Save trim material** -- Sugar leaves and trim can be used for extracts, edibles, or pre-rolls
...
![Drying room with hanging branches and environmental monitoring](/uploads/images/cultivation/drying-setup.jpg)

**Step-by-step drying setup:**

1. **Choose a dark room** -- Closet, spare room, or tent; no light exposure
2. **Set temperature** -- 60-70°F; use a small heater or AC if needed
3. **Set humidity** -- 45-55% RH; use a humidifier or dehumidifier as needed
4. **Install drying lines** -- String, wire, or specialized drying racks
5. **Hang branches** -- Upside down; spaced so buds don't touch
6. **Create indirect airflow** -- Oscillating fan pointed at a wall (not directly at buds)
7. **Monitor** -- Thermometer/hygrometer inside the drying space
8. **Keep door closed** -- Minimize air exchange to maintain conditions
...
- [ ] **Confirm readiness** -- Trichome examination (target ratio achieved)
- [ ] **Stop feeding** -- If not already flushed, begin plain pH water
- [ ] **Prepare drying space** -- Clean, dark, 60-70°F, 45-55% RH
- [ ] **Set up drying lines or racks** -- Adequate spacing for all material
- [ ] **Prepare tools** -- Trimming scissors, gloves, trays, alcohol for cleaning
- [ ] **Harvest** -- Cut whole plant or branches; handle gently
- [ ] **Remove fan leaves** -- Before or after drying (wet vs. dry trim)
- [ ] **Hang or rack** -- Space adequately; no buds touching
- [ ] **Set environment** -- Verify temperature, humidity, and airflow
- [ ] **Monitor daily** -- Check conditions; assess drying progress
- [ ] **Perform stem snap test** -- Beginning around day 7
- [ ] **Move to curing jars** -- When small stems snap (see [/cultivation/cure-store](/cultivation/cure-store))
