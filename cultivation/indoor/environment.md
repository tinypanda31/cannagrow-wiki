...
description: Managing the indoor grow environment -- temperature, humidity, VPD, ventilation, CO2 supplementation, odor control, and automation for optimal cannabis cultivation.
---
...
![Environmental monitoring equipment in an indoor grow space](/uploads/images/cultivation/environment-control.jpg)
...
- (Optional) Leaf surface temperature
...
1. **Replenishes CO2** -- Plants consume CO2 during photosynthesis; fresh air replenishes it
2. **Removes heat** -- Exhaust pulls hot air away from lights and canopy
3. **Controls humidity** -- Removes moisture-saturated air
4. **Strengthens stems** -- Air movement creates micro-stress that thickens stems
5. **Prevents microclimates** -- Stagnant air pockets invite mold and pests
...
**Adjustments:**
- Add 25% for carbon filter resistance
- Add 15% for ducting bends
- Add 20% for heat from lights (HID)
...
**Target CO2 levels:**
- Ambient air: ~400 PPM
- Enriched grow: 1,000-1,500 PPM
- Above 1,500 PPM: Diminishing returns; potential plant stress
...
**Best practices:**
- Size filter to match or exceed fan CFM rating
- Place filter inside the tent (fan pulls air through filter)
- Replace carbon every 12-18 months
- Pre-filter removes dust and extends carbon life
- Run fan continuously during flowering for consistent odor control
...
**Dehumidifier sizing:**
- A single cannabis plant can transpire 1-4 liters of water per day
- In a 4x4 tent with 4 plants, expect 4-16 liters/day of transpired water
- Choose a dehumidifier rated for at least the expected daily output
