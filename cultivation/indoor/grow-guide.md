---
title: Indoor Grow Guide
description: Complete step-by-step indoor cannabis cultivation guide from germination through harvest, drying, and curing. Covers equipment, environment, nutrients, training, and troubleshooting.
tags: indoor, grow-guide, cultivation, step-by-step, beginners, advanced, equipment, environment, nutrients, training, harvest, cure
---

# Indoor Cannabis Grow Guide

![Indoor cannabis grow room setup](/uploads/images/cultivation/indoor-grow-room.jpg)
...
**ℹ️ Note:** This guide references techniques and concepts covered in depth elsewhere on CannaGrow. Internal links are provided throughout — follow them for detailed background on [Basics](/genetics/basics), [Cannabinoids](/science/cannabinoids), [Terpenes](/science/terpenes), [Nutrients](/cultivation/nutrients/index), [Pests Diseases](/cultivation/pests-diseases), and [Autoflower Vs Photoperiod](/genetics/autoflower-vs-photoperiod).
...
Selecting the right strain for your space and experience level is critical. See [Strains](/strains/index) for the full database.
...
- Inspect the tent for pinholes, zipper gaps, and duct tape failures
- Cover any external LEDs or power indicators inside the tent with black electrical tape
- Open the tent only during the light period
...
See [Lighting](/cultivation/indoor/lighting) for the full technical breakdown. The short version:
...
### Light Intensity by Stage (PPFD Targets)

See [Lighting](/cultivation/indoor/lighting) for detailed PPFD measurement methodology.
...
## 5. Germination & Seedling (Weeks 1-3)
...
1. Moisten two paper towels with pH-adjusted water (6.0-6.5)
2. Place seeds between the damp towels
3. Put towels in a sealed plastic bag or between two plates
4. Store in a warm, dark location (70-80°F / 21-27°C)
5. Check daily — the taproot should emerge in **24-72 hours**
6. Once the taproot is 0.25-0.5 inches long, plant directly into the growing medium
...
#### Direct Planting Method (Lowest Transplant Shock)

1. Pre-moisten your grow medium with pH-adjusted water
2. Poke a hole 0.25-0.5 inches deep with a pencil or your finger
3. Drop the seed in, taproot-down if already sprouted, or point-down if not
4. Cover lightly with medium
5. Mist the surface gently
6. Keep warm (72-80°F / 22-27°C) and humid (65-70% RH)
7. Seedling should emerge in **3-7 days**

#### Water Soak Method

1. Fill a glass with pH-adjusted water (6.0-6.5) at room temperature
2. Drop seeds in and let them soak for 12-24 hours
3. Seeds that sink are viable; floating seeds may need more time or may be duds
4. Transfer sprouted seeds to grow medium immediately
...
1. Pre-fill the final pot with pre-moistened medium
2. Water the seedling lightly 30 minutes before transplanting
3. Gently remove the seedling from its starter container — do NOT pull by the stem
4. Place in the new pot and backfill with medium
5. Water lightly to settle the roots
6. Return to the grow space under gentle light for 24 hours
...
### VPD Chart for Vegetative Stage
...
**ℹ️ Note:** VPD targets shift by growth stage. See the VPD table in the Flowering section for bloom targets. For the full science of VPD and transpiration, see [Environment](/cultivation/indoor/environment).

### Training Techniques

See [Training](/cultivation/training) for detailed instructions on each method.
...
### Nutrient Schedule — Vegetative Stage
...
- [ ] Plant has 4-6+ nodes with healthy leaf development
- [ ] No signs of nutrient burn (brown leaf tips) or deficiency (yellowing, spotting)
- [ ] Training complete (topped, LST'd, or ScrOG'd as planned)
- [ ] Canopy is relatively even (all bud sites at similar height)
- [ ] Root mass fills the current container (visible at drainage holes)
- [ ] Final container is ready and pre-moistened
- [ ] pH pen and EC/TDS meter are calibrated

---

## 7. Flowering Stage (Weeks 7-14+)
...
- **NO light leaks during the 12-hour dark period** — even brief light exposure can cause hermaphroditism
- **Be patient** — plants will stretch 1.5-3x their veg height during the first 2-3 weeks of flower
- **Plan for the stretch** when setting light height and training
...
### Nutrient Schedule — Flowering Stage
...
- [ ] Light leak inspection complete (zero light during dark period)
- [ ] RH trending downward as buds densify
- [ ] Nutrient runoff pH and EC checked weekly
- [ ] Bud sites supported with trellis net or stakes as needed
- [ ] Defoliation of large fan leaves blocking bud sites completed (Day 1 and Day 21)
- [ ] Yellowing or dying leaves at the bottom of the plant removed (prevents pest habitat)
- [ ] Airflow maximized — oscillating fans directed at canopy, not directly on buds
- [ ] Trichome inspection began at Week 12 (see Harvest section)

---

## 8. Harvest

### When to Harvest — Trichome Inspection
...
In the final 10-14 days before harvest, feed only pH-adjusted water. This allows the plant to use up stored nutrients in its tissues, resulting in a smoother-smoking, better-tasting final product. See the debate about flushing efficacy in [Pests Diseases](/cultivation/pests-diseases).
...
- Fan leaves begin to yellow (starting at the bottom)
- Pistils (hairs) on buds darken from white to orange/brown
- Trichomes transition from clear to cloudy

### Harvesting — Whole-Plant vs. Branch-by-Branch
...
2. Cut the main stem at the base (whole-plant) or individual branches at the node
3. Remove large fan leaves (they contain few trichomes and hold moisture)
4. Leave sugar leaves intact during drying — they protect trichomes and curl inward as buds dry
5. Hang branches upside-down in the drying environment
...
- Hang whole branches upside-down from coat hangers, trellis net, or string
- Buds should not touch each other
- Space branches for air circulation
...
- If it **bends without snapping**: needs more time
- If the **outer stem cracks but doesn't fully snap**: ready for curing
- If it **snaps cleanly**: possibly over-dried (still usable but cure will be less effective)
...
### The Jar Curing Method

1. **Trim buds** — Remove sugar leaves and stems. Buds should be dense and manicured.
2. **Fill jars** — Pack trimmed buds into wide-mouth quart mason jars, filling each 3/4 full.
3. **Seal and store** — Close the lid and store in a cool, dark location (60-70°F / 16-21°C).
4. **Burp** — For the first 2 weeks, open each jar for 5-10 minutes, 1-2 times per day. This releases moisture and exchanges air.
5. **Monitor** — Use a mini hygrometer in one jar to monitor internal RH. Target: 58-62%.
   - Above 65%: Buds are too wet — leave jar open longer, more frequent burping
   - Below 55%: Buds are too dry — add a Boveda 62% pack or a damp paper towel for a few hours
6. **Reduce burping** — After 2 weeks, burp once every 2-3 days
7. **Long-term storage** — After 4-8 weeks of curing, seal jars and store in a cool, dark place. Buds improve for 6-12 months with proper storage.
...
See [Pests Diseases](/cultivation/pests-diseases) for comprehensive integrated pest management strategies.
...
| [Eco Friendly Cultivation](/sustainability/eco-friendly-cultivation) | Sustainable growing practices |
