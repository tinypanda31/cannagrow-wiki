---
title: Hydroponics
description: A complete guide to hydroponic cannabis cultivation, covering DWC, Ebb & Flow, Drip Systems, NFT, and Aeroponics with system comparisons, nutrient management, and troubleshooting.
---
...
![DWC bucket setup with net pot and air stone](/uploads/images/cultivation/dwc-bucket.jpg)
...
1. Cut a hole in the bucket lid to fit the net pot (or purchase a pre-cut DWC lid)
2. Fill the bucket with nutrient solution, leaving 1-2 inches of air space below the lid
3. Place a net pot filled with clay pebbles in the lid
4. Insert your seedling (in a rockwool cube or starter plug) into the clay pebbles
5. Place an air stone in the bucket and connect to an air pump
6. Position your light 18-24 inches above the net pot
7. Monitor water level, pH (5.5-6.5), and EC daily
8. Top off with pH-balanced water as needed; change reservoir every 7-10 days
...
1. Mix nutrients in water first
2. Wait 15-30 minutes for nutrients to fully dissolve
3. Measure pH
4. Adjust with pH Down (phosphoric acid) or pH Up (potassium hydroxide)
5. Re-measure after 15 minutes to confirm stability
...
- Wrap reservoir with reflective insulation
- Use frozen water bottles in the reservoir (temporary fix)
- Place reservoir outside the grow space
- Install a water chiller (most effective; $150-400)
- Use light-colored reservoirs (reflect heat)

## Common Hydroponic Nutrients
...
1. **Prepare buckets** -- Clean thoroughly; install net pot lids
2. **Mix nutrient solution** -- Fill each bucket with water; add nutrients per manufacturer schedule at 1/2 strength
3. **Adjust pH** -- Target 5.8-6.0; adjust with pH Up/Down
4. **Check EC** -- Should read 0.8-1.2 for early veg; adjust nutrient strength if needed
5. **Install aeration** -- Place air stone in each bucket; connect to air pump
6. **Start seedlings** -- Germinate seeds in rockwool cubes pre-soaked in pH 5.8 water
7. **Transfer to DWC** -- Once seedling has true leaves and roots emerge from rockwool, place in net pot surrounded by clay pebbles
8. **Set light** -- Position at appropriate distance for growth stage (see [/cultivation/indoor/lighting](/cultivation/indoor/lighting))
9. **Monitor daily** -- Check water level, pH, and EC every day for the first two weeks
10. **Establish routine** -- Full reservoir change every 7-10 days; top off with pH-balanced water between changes
