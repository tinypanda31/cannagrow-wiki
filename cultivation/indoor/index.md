...
description: A comprehensive guide to growing cannabis indoors, covering space selection, life cycle stages, equipment, and beginner-friendly setup recommendations.
---
...
Indoor cannabis cultivation offers the highest degree of control over every aspect of the growing environment. By recreating and optimizing natural conditions inside an enclosed space, growers can produce consistent, high-quality harvests year-round regardless of external weather conditions.

![Indoor cannabis grow tent with full setup](/uploads/images/cultivation/indoor-grow-tent.jpg)
...
- 600D+ canvas with mylar interior (95%+ reflectivity)
- Metal frame (not plastic connectors)
- Multiple ducting ports (6-12 inch)
- Observation window
- Removable floor tray
- Tool pockets and cord ports
...
- [ ] Seal all cracks and gaps to prevent light leaks and pest entry
- [ ] Paint walls with flat white or apply reflective material (Mylar, flat white paint reflects 85-95%)
- [ ] Ensure adequate ceiling height (minimum 6 ft / 1.8m; 8 ft / 2.4m ideal)
- [ ] Install light-proof covering on any windows
- [ ] Plan ventilation ducting route
- [ ] Ensure adequate electrical circuits (lights can draw 10-30 amps)
- [ ] Install waterproof flooring or tray
...
![Cannabis seed germination showing taproot emergence](/uploads/images/cultivation/germination.jpg)

**Step-by-Step Germination:**

1. **Prepare your medium** -- Pre-moisten starter cubes (Rockwool, Rapid Rooter) or paper towels with pH-adjusted water (6.0-6.5)
2. **Plant the seed** -- Place seed 1/4 to 1/2 inch deep in pre-moistened medium, or between damp paper towels
3. **Maintain warmth** -- Keep at 72-80°F (22-27°C); a seedling heat mat can help
4. **Keep dark** -- Seeds germinate best in darkness
5. **Wait for the taproot** -- In 24-120 hours, the seed cracks and a white taproot emerges
6. **Transfer to medium** -- If using paper towel method, carefully transfer germinated seed to your growing medium, taproot down
7. **Apply gentle light** -- Once the seedling emerges, provide 18-24 hours of light daily
...
**Key milestones:**
- Cotyledons (round seed leaves) appear first
- First true leaves (serrated) develop within 5-10 days
- Roots establish in initial container
- Plant is vulnerable to overwatering, heat, and strong light
...
- Train plants using LST, topping, or ScrOG (see [/cultivation/training](/cultivation/training))
- Monitor for nutrient deficiencies or excesses
- Establish the plant's structure and canopy
- Take clones if desired (from 3+ week old vegetative plants)
...
Harvest timing is determined by trichome maturity. See [/cultivation/harvest-dry](/cultivation/harvest-dry) for detailed harvesting procedures.

## Basic Indoor Setup Checklist
...
### Minimalist Starter Setup (~$400-600)
...
### Recommended Starter Setup (~$800-1,200)
