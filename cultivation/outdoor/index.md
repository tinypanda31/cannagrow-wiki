...
description: A guide to outdoor cannabis cultivation covering site selection, soil preparation, companion planting, seasonality, climate considerations, security, and scaling.
---
...
![Outdoor cannabis plants growing in a sunny garden setting](/uploads/images/cultivation/outdoor-grow.jpg)
...
- [ ] **Sun tracking** -- Observe the site throughout a full day during the growing season (June-August) to identify shade patterns
- [ ] **Water drainage test** -- Dig a 12-inch hole, fill with water; it should drain within 1-4 hours
- [ ] **Soil test** -- Test for pH (6.0-7.0 ideal), nutrient levels, and organic matter content
- [ ] **Wind assessment** -- Note prevailing wind direction and strength; identify natural windbreaks
- [ ] **Access route** -- Ensure you can transport soil, amendments, and equipment to the site
- [ ] **Security survey** -- Assess sight lines from roads, houses, and trails
...
1. **Dig a wide hole** -- 2-3x the size of the root ball (wider is better than deeper)
2. **Mix native soil with amendments** -- Combine native soil with compost (30-50%), worm castings, and dry amendments
3. **Charge the hole** -- Water the prepared hole and let it settle for 1-2 weeks before transplanting
4. **Plant at the right depth** -- Slightly deeper than the container (cannabis can grow adventitious roots from buried stems)
...
### Outdoor Growing Calendar (Northern Hemisphere, Temperate Climate)
...
1. **Week 1 before transplant:** Place seedlings outside for 2-3 hours in shade
2. **Days 3-4:** Increase to 4-6 hours; introduce some direct morning sun
3. **Days 5-6:** Full day outside; protect from wind
4. **Day 7:** Leave outside overnight (if temperatures are above 50°F / 10°C)
5. **Day 8:** Transplant into final outdoor location

## Autoflowers for Outdoor Growing

Autoflowering cannabis (containing _C. ruderalis_ genetics) offers unique advantages for outdoor cultivation:
...
- **Early Start:** Begin under lights in February/March; transplant in April
- **Succession Planting:** Sow new seeds every 3-4 weeks for continuous harvests
- **Late Season:** Plant in June/July for a fall harvest before frost
