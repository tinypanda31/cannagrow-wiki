---
title: Plant Training Techniques
description: A comprehensive guide to cannabis plant training methods including HST (topping, FIMing, main-lining), LST (bending, ScrOG, SOG), autoflower techniques, and timing recommendations.
---
...
Cannabis plants naturally grow in a conical shape (apical dominance) with one main central cola and diminishing lower branches. In indoor growing spaces, this natural shape wastes light and space. Training techniques manipulate plant structure to create an even canopy that maximizes light utilization and yield per square foot.

![Trained cannabis canopy showing even colas](/uploads/images/cultivation/plant-training.jpg)
...
![Topped cannabis plant showing dual main colas](/uploads/images/cultivation/topping.jpg)

**How to top:**

1. **Timing:** Wait until the plant has 4-6 nodes (typically 3-4 weeks into vegetative growth)
2. **Sterilize:** Use clean, sterilized scissors or pruning shears
3. **Locate the node:** Find the topmost node (where branches meet the stem)
4. **Cut:** Make a clean cut approximately 1/4 to 1/2 inch above the next node down
5. **Aftercare:** The plant may pause growth for 3-7 days while it redirects energy
...
1. Locate the newest growth tip (the very top cluster of small leaves)
2. Pinch or cut approximately 75% of this growth tip, leaving small portions on each side
3. The remaining tissue develops into 3-4+ new growth tips rather than 2
...
1. **Top** the plant at the 3rd node
2. **Wait** for two new branches to develop (5-7 days)
3. **LST** both branches horizontally, training them outward
4. **Top** each branch again when it has 3-4 nodes (now 4 branches)
5. **LST** all four branches outward
6. **Top** each of the four branches again (now 8 branches)
7. **Let grow** into flowering; optionally top again for 16 colas
8. **Switch to 12/12** and allow the 8-16 colas to flower evenly
...
- **Never remove more than 20-25% of foliage at once**
- **Only remove leaves that are shaded** (they consume more energy than they produce)
- **Never defoliate seedlings or stressed plants**
- **Fan leaves are nutrient factories** -- healthy, sunlit fan leaves should be preserved
- **During late flowering (weeks 6+), avoid defoliation**
...
1. Select a branch that is growing too tall
2. Pinch the branch between thumb and forefinger at the desired bend point
3. Apply gentle pressure and roll the stem until you feel the inner fibers soften (not snap)
4. Bend the branch to the desired angle
5. The outer stem layer should remain intact; only the inner tissue is damaged
6. Secure the branch in its new position with a tie if needed
7. The plant will heal the bend into a thickened, reinforced knuckle within 3-5 days
...
1. **Start early** -- Begin when the plant has 4-5 nodes and branches are still flexible (2-3 weeks into veg)
2. **Tie down** -- Use soft plant ties, garden wire, or string to gently pull branches down and outward
3. **Anchor** -- Tie to the pot rim, trellis netting, or eye hooks
4. **Maintain** -- Adjust ties every 2-3 days as branches grow and thicken
5. **Continue** -- Keep training through late veg; stop 1-2 weeks before flowering flip

**Key principles:**
- Bend branches **below the level of the main cola** to equalize hormone distribution
- **Be gentle** -- branches can snap if bent too sharply
- **Ties should be loose enough** to allow stem thickening but tight enough to hold position

### Screen of Green (ScrOG)

ScrOG uses a horizontal trellis net to create an entirely flat, even canopy.

![ScrOG screen with cannabis canopy filling evenly](/uploads/images/cultivation/scrog-screen.jpg)
...
1. **Install the screen** when plants are approximately 6 inches tall (2-3 weeks into veg)
2. **Weave branches** through the screen openings as they grow
3. **Tuck** growing tips under adjacent screen squares
4. **Continue tucking** every 2-3 days through vegetative growth
5. **Stop tucking** when the screen is approximately 70% filled (the plant will continue growing 50-100% during the flowering stretch)
6. **Switch to 12/12** when the desired fill is achieved
7. **Remove** any growth below the screen ("popcorn" buds) after the stretch
...
### Recommended Autoflower Techniques
