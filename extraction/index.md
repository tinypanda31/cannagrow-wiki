...
description: "Comprehensive guide to cannabis extraction methods, from solventless techniques to advanced solvent-based processes."
---
...
![Cannabis extraction methods overview](/uploads/images/extraction/extraction-overview.jpg)
...
- **Potent concentrates** -- Extracts can reach 60-99% cannabinoid content compared to 10-30% in raw flower
- **Product diversity** -- Extracts are the starting material for edibles, tinctures, topicals, and vape products
- **Consistent dosing** -- Concentrated and refined extracts allow precise measurement of active compounds
- **Medicine development** -- Standardized extracts are the basis for FDA-approved cannabinoid medications
- **Preservation** -- Properly stored extracts can maintain potency far longer than raw flower
- **Flavor and aroma** -- Terpene-rich extracts preserve the aromatic profile of specific cultivars

For background on the compounds being extracted, see [Cannabinoids](/science/cannabinoids) and [Terpenes](/science/terpenes).
...
## Solventless vs. Solvent-Based Methods
...
5. **Never work alone** -- Especially with solvent-based methods, having another person present is a critical safety measure.
6. **Source materials carefully** -- Only use food-grade or lab-grade solvents. Impure solvents introduce contaminants.
7. **Proper disposal** -- Follow local regulations for disposal of solvents, plant waste, and chemical byproducts.
...
1. **Decarboxylation is non-negotiable** (except for distillate). Without proper decarboxylation, edibles will not deliver activated THC or CBD. The time and temperature parameters vary by extract type -- see [Decarboxylation](/science/decarboxylation) for complete guidance.

2. **Potency varies dramatically.** From ~30% cannabinoids in low-grade kief to ~99% in distillate, understanding your extract's potency is essential for safe and consistent dosing.

3. **Solvent safety matters.** Solventless extracts (kief, hash, rosin) carry zero residual solvent risk. Solvent-based extracts (BHO, ethanol, CO2) must be properly processed and tested before edible conversion.

4. **The entourage effect in edible form.** Full-spectrum extracts (rosin, hash, live resin) deliver the complete cannabinoid and terpene profile in edible form, potentially offering different effects compared to single-cannabinoid distillate edibles.
...
- [Cannabinoids](/science/cannabinoids) -- Understanding THC, CBD, and other compounds
