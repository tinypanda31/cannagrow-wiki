...
description: "Educational overview of ethanol-based cannabis extraction including QWET, winterization, and commercial ethanol extraction systems."
---
...
![Ethanol extraction equipment](/uploads/images/extraction/ethanol-extraction.jpg)
...
- **Short wash** (30 seconds to 3 minutes) -- Produces cleaner extract with less chlorophyll and waxes; preferred for QWET (Quick Wash Ethanol Technique)
- **Long wash** (30 minutes to several hours) -- Extracts more total cannabinoids but also more chlorophyll, lipids, and water-soluble compounds; used for full-extraction processes
...
### Step 5: Evaporate/Recover Ethanol
...
1. Dissolve the crude extract in warm ethanol
2. Place the solution in a freezer at -40 to 0 degrees F (-40 to -18 degrees C) for 24-48 hours
3. During this time, lipids and waxes solidify and precipitate out of solution
...
## Temperature and Wash Time Effects
...
## Decarboxylation for Ethanol Extracts
...
- Place extract in a heat-safe glass container
- Heat at 220-240 degrees F (104-116 degrees C) for 30-60 minutes
- RSO and full-spectrum ethanol extracts are thick and viscous, requiring thorough heating to ensure complete decarboxylation throughout the mass
- The extract will bubble as CO2 is released -- this is the decarboxylation reaction in progress
...
## Common Products from Ethanol Extraction
