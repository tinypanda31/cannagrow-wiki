---
title: "Dry Sift & Kief"
description: "Guide to dry sifting cannabis trichomes and collecting kief using screens and mechanical agitation."
---
...
![Dry sift kief on glass surface](/uploads/images/extraction/dry-sift-kief.jpg)
...
- **Cannabinoids** (THC, CBD, CBG, and others in their acidic forms)
- **Terpenes** (aromatic compounds responsible for flavor and aroma)
- **Flavonoids** (pigment compounds with potential therapeutic properties)
- **Plant lipids and waxes** (from the trichome stalk and head)

Trichome heads typically range from 70 to 120 microns in diameter, which determines the screen sizes used for effective separation. See [Cannabinoids](/science/cannabinoids) and [Terpenes](/science/terpenes) for more information on these compounds.

## Collecting Kief from Grinders
...
- Use a small brush to collect kief from the screen and chamber
- Accumulation rates vary based on flower quality, trichome density, and grind frequency
- Grinder-collected kief typically contains more plant matter than purpose-sifted kief

## Dry Sift Screens and Micron Ratings
...
- **Stainless steel wire mesh** -- Most durable and accurate sizing; preferred for professional use
- **Nylon/polyester mesh** -- Less expensive; may degrade over time; adequate for casual use
- **Stretched silk** -- Traditional material; still used in some hash-producing regions

## Multi-Chamber Sifters
...
### Typical Multi-Chamber Setup

```
Top: 160 micron (removes large plant material)
  |
  v
Middle: 90-120 micron (collects mid-grade kief)
  |
  v
Bottom: 45-73 micron (collects premium kief)
  |
  v
Collection tray (finest particles)
```

### Popular Sifter Designs

- **Flat-bed screens** -- Rectangular or circular mesh frames; material is agitated across the surface
- **Cylinder/tumbler sifters** — Rotating drum with mesh; continuous sifting action
- **Nested screens** — Stackable mesh discs; compact and portable
...
1. Use a soft-bristle brush (makeup brushes work well) to remove residual particles
2. For stubborn buildup, 70%+ isopropyl alcohol can dissolve resin -- rinse thoroughly and dry completely before reuse
3. Never use sharp objects to scrape screens -- this damages the mesh and affects accuracy

## Quality Grades of Dry Sift Kief
...
1. Load kief into the press cylinder
2. Apply steady pressure using the threaded mechanism
3. Maintain pressure for several hours or overnight
4. Eject the compressed hash puck
...
- Kief
- Parchment paper
- Heat source (warm water bottle, hot water glass, or low-temperature iron)
- Flat, rigid surface

**Step-by-Step:**

1. Place kief in the center of a piece of parchment paper
...
- Spread kief evenly on parchment-lined baking sheet
- Heat at 220-240 degrees F (104-116 degrees C) for 25-40 minutes
- Kief decarboxylates faster than flower due to its concentrated nature and increased surface area
- Monitor color change: properly decarbed kief shifts from light tan/green to a deeper golden-brown
...
- **1 gram of average kief (~50% cannabinoids)** contains approximately 500mg of total cannabinoids
- For a standard 10mg THC edible serving, you would need roughly 0.02 grams (20mg) of 50% kief per serving, assuming ~50% THC within the cannabinoid content
- **Start low:** If unsure of your kief's potency, begin with a small test batch and assess effects before scaling up
...
- **Solvent-free:** Zero risk of residual solvent contamination
- **Easy to incorporate:** Fine powder blends readily into butter, oil, or alcohol
- **Full-spectrum:** Delivers the complete cannabinoid and terpene profile of the source material
- **Traditional and proven:** Decades of culinary use demonstrate its reliability
- **Cost-effective:** Kief is often the most affordable concentrated extract for edible preparation

For detailed edible preparation techniques, dosing strategies, and recipes, see [Edibles](/consumption/edibles/index).
