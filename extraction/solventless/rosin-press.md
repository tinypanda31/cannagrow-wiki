---
title: "Rosin Press"
description: "Guide to rosin extraction using heat and pressure -- a solventless method for producing high-quality cannabis concentrates."
---
...
![Rosin being pressed from hash](/uploads/images/extraction/rosin-press.jpg)
...
1. **Heat** softens the resinous contents of trichomes and reduces their viscosity
2. **Pressure** physically squeezes the liquefied resin from the plant material or hash
3. **Filtration** (when using bags) removes plant matter and larger contaminants
...
- Grind or break up buds to a consistent, moderate texture (not too fine)
- Some producers lightly moisten flower (58-62% RH) for better flow
- Pre-press into "pucks" using a flower mold or by hand -- this creates uniform, dense pucks that press more efficiently

**Step 2: Load the Parchment**

- Cut parchment paper to size (approximately 4x4 inches / 10x10 cm)
- Place the flower puck in the center and fold the parchment over it
- The parchment acts as a filter and collection surface

**Step 3: Pre-Press**

- Place the parchment-wrapped puck between the press plates
- Close the plates slowly until you feel initial resistance
- Hold light pressure for 5-10 seconds to allow the material to warm

**Step 4: Apply Full Pressure**

- Gradually increase pressure to the target range
- Hold for the recommended duration (30 seconds to 3 minutes)
...
- Carefully open the plates and remove the parchment
- While the rosin is still warm and pliable, use a dab tool to gather it from the parchment
- Transfer to a glass container for storage or curing

### Burst vs. Steady Press
...
### Cold Cure Method (Most Common for Hash Rosin)

1. Fresh-press hash rosin into a glass jar (do not collect from parchment)
2. Seal the jar and store at room temperature (65-75 degrees F / 18-24 degrees C)
3. Open the jar daily for the first few days to "burp" (release pressure and allow oxygen exchange)
4. Stir occasionally with a dab tool to encourage even crystallization
5. After 1-4 weeks, the rosin should develop a badder or jam consistency
6. Store cured rosin in a cool, dark place
...
## Commercial Rosin Production

Commercial rosin production scales up the same principles used in home pressing:

- **Large-format presses** -- Plates measuring 12x12 inches (30x30 cm) or larger process multiple pucks simultaneously
- **Automated systems** -- Pneumatic presses with programmable pressure, temperature, and time profiles ensure batch consistency
- **Quality control** -- Lab testing for potency, residual moisture, and contamination
- **Cold chain logistics** -- Fresh frozen material and finished rosin are kept refrigerated or frozen throughout processing and distribution
- **Packaging** -- Small glass jars (0.5g, 1g, 3.5g) stored refrigerated to preserve freshness
...
- Place rosin in a heat-safe glass container or on parchment
- Heat at 220-240 degrees F (104-116 degrees C) for 20-35 minutes
- Rosin decarboxylates relatively quickly due to its concentrated, oil-like consistency
- The rosin will bubble during decarboxylation as CO2 is released -- this is normal
- After decarboxylation, the rosin will be slightly darker and more fluid

See [Decarboxylation](/science/decarboxylation) for complete temperature and time guidance, including how to determine decarboxylation percentage.

### Dosing Guidance

Rosin is **highly potent** and requires careful dosing:

- **Hash rosin:** Typically 60-90%+ total cannabinoids
- **Flower rosin:** Typically 50-70% total cannabinoids

**Practical dosing example:**
- 1 gram of hash rosin at 75% cannabinoids contains approximately 750mg total cannabinoids
...
- **Full-spectrum:** Delivers the complete cannabinoid and terpene profile, supporting the entourage effect in edible form
- **Premium quality:** Hash rosin edibles represent the highest tier of solventless edible production
