...
- [Chromosomes and Genome](#chromosomes-and-genome)
- [Inheritance Patterns](#inheritance-patterns)
- [The Three Subspecies](#the-three-subspecies)
- [Landraces](#landraces)
- [The Indica/Sativa Debate](#the-indicasativa-debate)
- [Chemotype Classification](#chemotype-classification)
- [Hybridization](#hybridization)
- [Modern Genetic Testing](#modern-genetic-testing)
- [See Also](#see-also)
...
- **Yield potential** — The maximum biomass and flower production under optimal conditions
...
- **Light** — Intensity, spectrum, photoperiod, and daily light integral (DLI)
- **Nutrients** — Availability and balance of macro- and micronutrients
- **Water** — Frequency, volume, pH, and dissolved oxygen content
- **Climate** — Temperature, humidity, vapor pressure deficit (VPD), and CO2 concentration
...
The **genotype** refers to the complete set of genes carried within an organism's DNA. It is the inherited genetic code — the specific alleles (variant forms of a gene) present at each locus (position) on the chromosomes. The genotype is fixed at fertilization and does not change throughout the organism's life (barring mutations).
...
The **phenotype** refers to the observable characteristics of an organism — its morphology (physical form), chemistry, behavior, and performance. The phenotype is the result of the genotype **interacting** with the environment. It is not fixed; it can vary based on growing conditions.
...
When two cannabis plants are crossed (bred), the offspring inherit a **random recombination** of each parent's genes. During meiosis (the cell division that produces pollen and ovules), chromosomes undergo **crossing over** — segments of DNA are exchanged between paired chromosomes, creating novel combinations of alleles in each reproductive cell.
...
1. **Germinating a population** — Often 50 to 500+ seeds from a single cross
2. **Growing under uniform conditions** — Identical light, nutrients, medium, and training to ensure fair comparison
3. **Evaluating phenotypes** — Assessing structure, vigor, resin production, aroma, cannabinoid content, flowering time, and yield
...
The environment plays a profound role in determining which genes are **expressed** (turned on or off) and to what degree. This field of study is called **epigenetics** — changes in gene expression that do not involve changes to the underlying DNA sequence.

Key environmental factors that influence phenotypic expression in cannabis:

| Environmental Factor | Phenotypic Effect |
|---|---|
| **Light intensity (PPFD)** | Higher intensity generally increases trichome density, cannabinoid concentration, and overall biomass — up to the genetic ceiling |
...
### Chromosome Count and Structure
...
### What Cannabis Genes Code For

The cannabis genome contains approximately **30,000–40,000 genes**, of which several categories are particularly relevant to cultivators and breeders:
...
![Cannabis chromosome diagram showing the 10 pairs with annotated gene locations for cannabinoid and terpene synthesis pathways](/uploads/images/genetics/cannabis-chromosomes.jpg)
...
- **Law of Independent Assortment**: Genes for different traits are inherited independently of one another (with exceptions due to genetic linkage — genes located close together on the same chromosome tend to be inherited together).
...
### Dominant vs. Recessive Traits in Cannabis
...
While both parents are *bb* at the cannabinoid ratio locus (ensuring all offspring will also be *bb* and thus THC-dominant), the **total THC percentage** is a **polygenic trait** controlled by many genes beyond the *B* locus — including genes affecting trichome density, resin gland size, metabolic rate, and overall plant vigor. Each offspring inherits a random combination of these genes.

Some offspring may exceed both parents in THC content (transgressive segregation), while others may fall significantly below. This is why breeders grow large populations and select the top performers — the genetic lottery produces a distribution of outcomes, not uniform copies of the parents.

### Polygenic Traits

The majority of agriculturally important traits in cannabis are **polygenic** — controlled by the combined action of many genes, each contributing a small effect. These traits exhibit **continuous variation** (a range of values) rather than discrete categories.

Polygenic traits in cannabis include:

- **Total cannabinoid content** (percentage of THC, CBD, etc.) — influenced by trichome density, gland size, enzyme activity, and metabolic flux
...
![Geographic distribution map showing the ancestral origins of Cannabis subspecies: sativa (equatorial regions), indica (Hindu Kush mountains), and ruderalis (Central Asian steppes)](/uploads/images/genetics/subspecies-distribution-map.jpg)

### *Cannabis sativa* subsp. *sativa*

**Ancestral Region**: Equatorial and tropical regions worldwide — Central and South America, Africa, Southeast Asia, and the South Pacific.

**Morphological Characteristics**:

| Trait | Description |
|---|---|
| **Height** | Tall, often 12–20 feet (3.5–6 m) outdoors; can exceed 20 feet in ideal equatorial conditions |
| **Structure** | Open branching pattern with wide internodes; lanky appearance |
| **Leaves** | Narrow leaflets (digitate, typically 9–13 leaflets per leaf); light green coloration |
| **Flowering time** | Long — typically 10–16+ weeks; some equatorial landraces may not flower until late November in the Northern Hemisphere |
...
**Chemical Profile**: Traditionally associated with higher ratios of THCV, limonene, terpinolene, and pinene — terpenes associated with energizing, uplifting effects. Modern sativa-dominant cultivars span the full range of cannabinoid and terpene profiles.

**Notable Landrace Examples**:

- **Colombian** — From the Sierra Nevada de Santa Marta region; known for energetic, creative effects
- **Mexican** — From the highlands of Guerrero, Oaxaca, and Chiapas; diverse populations with varying chemotypes
- **Thai** — From Southeast Asia; extremely long flowering period, narrow leaflets, potent and clear-headed effects
- **Vietnamese** — From the highlands of Vietnam; similar to Thai but often with unique terpene profiles
- **Malawi Gold** — From Malawi, Africa; legendary landrace known for golden coloration and potent effects
- **Durban Poison** — From Durban, South Africa; one of the most famous pure sativa landraces, sweet/anise terpene profile
- **Acapulco Gold** — From the hills near Acapulco, Mexico; golden-green coloration, energetic effects

**Adaptations**: Evolved in regions with consistent 12/12 light cycles year-round (near the equator) or with relatively small seasonal variation. This is why equatorial sativas often have difficulty flowering at higher latitudes, where autumn days remain relatively long. Their airy bud structure is an adaptation to high humidity and heavy rainfall in tropical environments — dense buds would quickly develop mold in these conditions.
...
| Trait | Description |
|---|---|
| **Height** | Short to medium, typically 3–6 feet (1–1.8 m) outdoors; compact indoors |
| **Structure** | Dense, bushy architecture with tight internodes; conical shape |
| **Leaves** | Broad leaflets (digitate, typically 7–9 leaflets per leaf); dark green coloration |
| **Flowering time** | Fast — typically 7–9 weeks; adapted to short mountain growing seasons |
...
**Chemical Profile**: Traditionally associated with higher myrcene, caryophyllene, and linalool content — terpenes associated with relaxing, sedating effects. High resin production is characteristic.

**Notable Landrace Examples**:

- **Afghan** — From various regions of Afghanistan; heavy resin production, dense structure, deeply relaxing effects
- **Pakistani** — From the mountainous regions of northern Pakistan; similar to Afghan but often with unique terpene variation
- **Hindu Kush** — From the Hindu Kush mountain range; the archetypal indica landrace, short flowering, heavy body effects
- **North Indian** — From the Kashmir and Himachal Pradesh regions; often produced as hashish traditionally; spicy, earthy profiles
- **Kazakh** — From the southern regions of Kazakhstan; sometimes classified as intermediate between indica and ruderalis
...
| Trait | Description |
|---|---|
| **Height** | Very small — typically 1–2.5 feet (30–75 cm) |
| **Structure** | Sparse, weed-like appearance; thin stems; minimal branching |
| **Leaves** | Narrow, small leaflets (typically 3–5 leaflets per leaf); light green |
| **Flowering time** | Autoflowering — begins flowering 3–4 weeks after germination regardless of photoperiod; completes lifecycle in 70–90 days from seed |
...
- **Russian Ruderalis** — First studied by Russian botanist D.E. Janischewsky in 1924, who formally classified it as a separate species (later reclassified as a subspecies)
- **Central Asian wild populations** — Found across the steppes from Kazakhstan to eastern Europe
- **Volga region** — One of the most studied populations due to accessibility
...
| **Height** | 12–20+ ft (3.5–6+ m) | 3–6 ft (1–1.8 m) | 1–2.5 ft (30–75 cm) |
| **Structure** | Tall, lanky, open | Short, bushy, dense | Small, sparse, weedy |
| **Leaflets** | Narrow (9–13 per leaf) | Broad (7–9 per leaf) | Narrow (3–5 per leaf) |
| **Flowering Trigger** | Photoperiod | Photoperiod | Age (autoflowering) |
| **Flowering Duration** | 10–16+ weeks | 7–9 weeks | 3–4 weeks after germ |
...
### What Makes a Strain a "Landrace"
...
- **1960s–1970s**: The "Hashish Trail" — Western travelers collected landrace seeds from Morocco, Afghanistan, Pakistan, India, Nepal, Thailand, Vietnam, and Colombia during overland journeys
- **1970s–1980s**: Early breeding programs in the United States and Netherlands began crossing collected landraces, creating the first modern hybrids
- **1980s–1990s**: Stabilization of early hybrid cultivars; sinsemilla (seedless female) cultivation techniques became widespread
- **1990s–2000s**: The rise of indoor growing and the "clone-only" era; famous hybrids like OG Kush, White Widow, and Northern Lights were released
- **2000s–present**: The "gelato" and "cookies" era; further hybridization concentrating genetics from a narrowing pool of elite clones

### Threats to Landrace Genetics
...
### The Traditional Model (and Why It Is Problematic)

The traditional consumer model holds that:

- **Indica** strains produce a "body high" — sedating, relaxing, physically calming effects. Recommended for evening/nighttime use.
- **Sativa** strains produce a "head high" — energizing, cerebral, creative effects. Recommended for daytime use.
...
4. **Consumer products labeled "indica" or "sativa" show no consistent chemical differentiation.** Studies analyzing dispensary products labeled as indica or sativa have found no significant differences in cannabinoid or terpene profiles between the two categories. A product labeled "indica" may have an identical chemical profile to one labeled "sativa."

### Why the Terms Persist
...
- **Increased growth rate** — Faster vegetative growth than either parent
- **Higher yield** — Greater biomass and flower production
- **Enhanced stress tolerance** — Better resilience to environmental fluctuations
- **Improved disease resistance** — Broader immune response from combined genetic diversity
...
1. **Geographic mixing**: When landraces from different regions were brought together, cross-pollination was unavoidable. Afghan crossed with Colombian. Thai with Hindu Kush. These initial crosses created the F1 hybrids that became the foundation of modern breeding.

2. **Selection for combined traits**: Breeders intentionally crossed subspecies to combine desirable traits — the fast flowering and dense buds of indica with the yield and structural height of sativa, for example.

3. **Hybrid vigor**: The increased vigor, yield, and resilience of F1 hybrids made them superior cultivation candidates, and they rapidly displaced pure landraces in production settings.

4. **Genetic bottlenecking**: Over successive generations of breeding, the genetic pool narrowed as breeders repeatedly crossed a small number of elite clones. Modern "cut" culture (clone-based propagation) further concentrated genetics from a limited number of famous parent plants.

### The Genetic Dilution of Landraces

Each generation of hybridization dilutes the genetic contribution of the original landrace parents. By the F5 or F6 generation of a multi-line cross, the genetic contribution of any single landrace ancestor may be reduced to less than 5% of the genome. This is not inherently negative — it is the natural result of selective breeding combining traits from multiple sources. However, it means that very few, if any, modern cultivars retain the complete genetic profile of any single landrace.
...
### Applications of Genetic Testing in Cannabis
...
Molecular markers linked to cannabinoid synthase genes allow breeders to predict the chemotype of seedlings before they flower — dramatically accelerating breeding timelines. Instead of waiting 3–4 months for a plant to flower and analyzing its chemistry, breeders can test leaf tissue from seedlings and identify the likely chemotype within weeks of germination.
...
|---|---|
| **Cost** | Comprehensive genetic analysis remains expensive ($50–$500+ per sample), limiting accessibility for small breeders and cultivators |
