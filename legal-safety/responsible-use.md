...
For adults in jurisdictions where cannabis use is legal, understanding how to use cannabis responsibly is essential for personal safety and public well-being. This page provides evidence-based guidance on responsible cannabis consumption, drawing on public health research, clinical data, and harm reduction principles.
...
Cannabis products vary enormously in potency. Responsible use requires understanding what you are consuming.
...
The ratio of THC to CBD affects the experience:
...
Research consistently shows that cannabis use during adolescence — when the brain is still developing — is associated with greater risks than adult use, including impacts on cognitive development, educational outcomes, and mental health. See [Harm Reduction](/legal-safety/harm-reduction) for more detail.
:::
...
Even experienced users can overconsume, especially with edibles or unfamiliar products.
...
1. **Stay calm** — No one has ever died from a cannabis overdose alone. The experience is uncomfortable but not life-threatening in isolation.
2. **Move to a safe, quiet environment** — Reduce sensory input (dim lights, quiet room)
3. **Hydrate** — Drink water slowly
4. **Rest** — Lie down if dizzy; sit up if feeling nauseated
5. **Have a sober person present** — Someone should monitor the individual until effects subside
6. **CBD may help** — Some evidence suggests CBD can counteract some effects of THC
7. **Seek medical help if**:
   - Symptoms are severe or worsening after several hours
   - The person has a pre-existing heart condition
...
Regular cannabis use leads to **tolerance** — the body becomes less responsive to the same dose over time.
...
If you find that you need cannabis to function normally, experience withdrawal symptoms when not using, or are unable to reduce consumption despite wanting to, these may be signs of cannabis use disorder. See [Harm Reduction](/legal-safety/harm-reduction) for information on dependency and when to seek help.
:::
...
The context in which cannabis is consumed significantly affects the experience.
...
| **Mixing substances** | Avoid combining cannabis with alcohol, prescription medications, or other drugs without understanding interactions. See [Harm Reduction](/legal-safety/harm-reduction) for drug interaction information. |
...
- Potency labels may be inaccurate
- Products may be contaminated with pesticides, mold, or heavy metals
...
Even where cannabis is legal, public consumption is often restricted:
...
- Use cannabis daily or multiple times per day
- Have tried to reduce use and found it difficult
- Experience withdrawal symptoms (irritability, sleep disturbance, decreased appetite, anxiety) when not using
- Use cannabis to manage mental health symptoms without professional guidance
- Have a personal or family history of substance use disorder or psychosis
- Have concerns about interactions with prescription medications

For resources, see [Harm Reduction](/legal-safety/harm-reduction).

---

## Quick Reference: Responsible Use Checklist

- [ ] I know the potency of the product I am using
- [ ] I am starting with a low dose, especially with new products
- [ ] I have waited long enough before considering more (15 min for inhalation, 2+ hours for edibles)
- [ ] I am not driving or operating machinery
...
*See also: [Harm Reduction](/legal-safety/harm-reduction) | [Legal Landscape](/legal-safety/legal) | [Cannabinoids Overview](/science/cannabinoids)*
