---
title: "Cannabinoids"
description: "Comprehensive scientific guide to cannabis cannabinoids including THC, CBD, CBG, CBN, CBC, THCV, and more."
---
...
![Cannabinoid molecular structures](/uploads/images/science/cannabinoid-structures.jpg)
...
1. **Precursor availability**: Cell membranes contain phospholipids with arachidonic acid tails. When a postsynaptic neuron is depolarized (activated), calcium influx triggers enzymatic pathways.
2. **Enzymatic conversion**: For anandamide (AEA), the enzyme **N-acyl phosphatidylethanolamine-specific phospholipase D (NAPE-PLD)** converts membrane phospholipids into AEA. For 2-AG, the enzymes **phospholipase C (PLC)** and **diacylglycerol lipase (DAGL)** work sequentially to produce 2-AG from membrane phosphatidylinositol.
3. **Immediate release**: Once synthesized, endocannabinoids diffuse directly through the cell membrane -- they are not stored in vesicles.
4. **Rapid degradation**: After fulfilling their signaling role, endocannabinoids are quickly broken down by enzymes. **FAAH (fatty acid amide hydrolase)** degrades anandamide, while **MAGL (monoacylglycerol lipase)** degrades 2-AG.
...
1. The **postsynaptic neuron** is activated by incoming neurotransmitters (glutamate, GABA).
2. Calcium influx in the postsynaptic cell triggers **on-demand synthesis** of endocannabinoids from membrane lipids.
3. Endocannabinoids **diffuse backwards** across the synaptic cleft (they are lipophilic and pass through membranes easily).
4. They bind to **CB1 receptors on the presynaptic terminal**.
5. CB1 activation inhibits voltage-gated calcium channels in the presynaptic neuron, **reducing further neurotransmitter release**.
6. This creates a **negative feedback loop**: when the postsynaptic cell is overstimulated, it signals the presynaptic cell to "turn down the volume."
...
- **Positive allosteric modulators (PAMs)**: Make the receptor more responsive to its natural ligand (amplify the signal).
- **Negative allosteric modulators (NAMs)**: Make the receptor less responsive to its natural ligand (dampen the signal).
...
- **Agonism**: Binding to and activating a receptor (e.g., THC activates CB1 receptors)
- **Antagonism**: Binding to a receptor and blocking it from activation (e.g., THCV at low doses blocks CB1)
- **Allosteric modulation**: Binding to a secondary site on a receptor, altering how other molecules bind (e.g., CBD acts as a negative allosteric modulator at CB1)
- **Enzyme inhibition**: Preventing the breakdown of endocannabinoids (e.g., CBD inhibits FAAH)
- **Reuptake inhibition**: Blocking the reabsorption of endocannabinoids, increasing their availability
...
- **Pain circuits**: Endocannabinoids normally dampen pain signals; THC amplifies this effect.
- **Reward circuits**: THC increases dopamine release in the nucleus accumbens by inhibiting GABA interneurons that normally suppress dopamine neurons.
- **Memory circuits**: CB1 receptors in the hippocampus modulate synaptic plasticity; THC disrupts short-term memory formation.
- **Appetite circuits**: Endocannabinoids in the hypothalamus regulate feeding behavior; THC stimulates appetite.
- **Immune function**: CB2 receptors on immune cells regulate inflammatory responses; cannabinoids modulate inflammation.
...
![Endocannabinoid system diagram](/uploads/images/science/ecs-diagram.jpg)
...
- **Molecular formula:** C21H30O2 (structural isomer of Delta-9-THC)
- **Molecular weight:** 314.47 g/mol
...
- **Trichome maturity**: Cannabinoid synthesis peaks when glandular trichomes transition from clear to cloudy/amber. Harvesting too early yields lower cannabinoid concentrations; harvesting too late allows more degradation to CBN.
- **Light spectrum and intensity**: UV-B radiation stimulates cannabinoid production as a protective response. This is one hypothesis for why high-altitude, high-UV cannabis (e.g., from Afghanistan or Morocco) tends to be more potent.
- **Temperature**: Optimal cannabinoid synthesis occurs at 20-30 degrees C (68-86 degrees F). Extreme heat or cold reduces production.
- **Nutrient stress**: Moderate nutrient stress can increase trichome production (and thus cannabinoid content) as a defense response, though severe stress reduces overall plant health and yield.
- **Plant sex**: Female plants produce significantly more trichomes (and therefore cannabinoids) than males. Unpollinated females ("sinsemilla") produce the highest concentrations.

![Cannabinoid biosynthesis pathway](/uploads/images/science/biosynthesis-pathway.jpg)
...
- **CB1 (Gi/o-coupled)**: Primary site of psychoactive action; high-affinity partial agonist
- **CB2 (Gi/o-coupled)**: Lower affinity than CB1; contributes to anti-inflammatory effects
- **5-HT3A**: Serotonin receptor; may contribute to anti-nausea effects
- **GPR55**: Orphan receptor; possible role in bone metabolism
- **PPAR-gamma**: Nuclear receptor; gene regulation, metabolism
- **TRPV1**: Vanilloid receptor; pain, temperature regulation
...
- Euphoria and reward: Dopamine release in nucleus accumbens
- Short-term memory impairment: Glutamate inhibition in hippocampus
- Increased appetite: CB1 activation in hypothalamus
- Altered time perception: CB1 effects in the basal ganglia and cerebellum
- Reduced pain: CB1 activation in periaqueductal gray (PAG) and spinal cord
- Anxiety/paranoia (high dose): Amygdala CB1 overactivation, GABA disruption
...
**Primary receptor targets:**
- **CB1 (negative allosteric modulator)**: Reduces THC's efficacy at CB1
- **5-HT1A (agonist)**: Serotonin receptor; anti-anxiety, anti-nausea
- **TRPV1 (agonist)**: Vanilloid receptor; pain, inflammation
- **GPR55 (antagonist)**: May contribute to anti-cancer and bone effects
- **PPAR-gamma (agonist)**: Anti-inflammatory, neuroprotective
- **FAAH (inhibitor)**: Increases anandamide levels
...
**Subjective effects tied to mechanism:**
- Reduced anxiety: 5-HT1A agonism, increased anandamide
- Anti-seizure: Multiple mechanisms including TRPV1, GPR55, adenosine
- Reduced inflammation: PPAR-gamma activation, TRPV1
- Counteracting THC effects: CB1 negative allosteric modulation
- General sense of calm without sedation: Multi-target modulation
...
**Primary receptor targets:**
- **CB1 (weak partial agonist)**: Low affinity
- **CB2 (weak partial agonist)**: Slightly higher affinity than at CB1
- **Alpha-2 adrenergic receptor (agonist)**: Pain modulation, anxiety
- **5-HT1A (antagonist)**: May modulate serotonin signaling
- **TRPA1 (agonist)**: Pain, inflammation
...
**Primary receptor targets:**
- **CB1 (weak partial agonist)**: Approximately 10% of THC's affinity
- **CB2 (agonist)**: Moderate affinity; may contribute to immune effects
- **TRPA1 (agonist)**: Pain, inflammation
- **TRPV2 (agonist)**: Temperature regulation, immune function
...
**Primary receptor targets:**
- **TRPV1 (agonist)**: Significant activity; pain, inflammation
- **TRPA1 (agonist)**: Pain, itch sensation
- **CB2 (weak agonist)**: Immune modulation
- **CB1 (negligible)**: Non-psychoactive
- **Endocannabinoid reuptake inhibition**: May increase anandamide levels
...
**Primary receptor targets:**
- **CB1**: Antagonist at low doses; agonist at high doses (unique dose-dependent switch)
- **CB2 (agonist)**: Moderate affinity
- **5-HT1A (agonist)**: May contribute to anti-anxiety effects
- **TRPV1 (agonist)**: Pain modulation
...
**Primary receptor targets:**
- **THCA**: Does not bind CB1; may interact with **COX-1/COX-2** (like NSAIDs), **TRPV1**, and **TRPV2**
- **CBDA**: High affinity for **5-HT1A** (potentially higher than CBD); may activate **TRPV1**
...
**Primary receptor targets:**
- **CB1 (partial agonist)**: Similar to Delta-9-THC but lower affinity
- **CB2 (partial agonist)**: Similar profile to Delta-9-THC
...
1. **Grind coarsely**: Break flower into pea-sized pieces. Too fine = burns; too coarse = uneven decarb.
2. **Use an oven thermometer**: Oven dials are often inaccurate by 10-25 degrees F.
3. **Spread evenly on parchment-lined baking sheet**: Ensures uniform heat exposure.
4. **Cover loosely with foil**: Reduces terpene loss while allowing CO2 to escape.
5. **Stir halfway through**: Promotes even heating.
6. **Color as indicator**: Properly decarbed cannabis turns from green to light brown/tan. Dark brown or black indicates over-decarboxylation (cannabinoid degradation).
...
- **Fat content**: Cannabinoids are highly lipophilic. Consuming them with dietary fat significantly increases oral bioavailability. One study showed a **2.5- to 3-fold increase** in THC absorption when cannabis was consumed with a high-fat meal compared to fasting.
- **Particle size** (for inhalation): Smaller particles reach deeper into the lungs, increasing absorption. Larger particles deposit in the mouth and throat and are swallowed.
- **Holding smoke/vapor in lungs**: Studies show that holding breath beyond 3-5 seconds provides negligible additional absorption. Most THC is absorbed during the initial inhalation.

### Distribution

Once absorbed, cannabinoids distribute throughout the body according to their **lipophilicity** (fat solubility):

- **Volume of distribution (Vd)**: THC has an extremely large Vd (~10 L/kg), meaning it distributes far beyond the blood into tissues throughout the body. This is one of the largest Vd values of any drug.
- **Fat storage**: THC and its metabolites accumulate in **adipose tissue (body fat)**, where they can persist for days to weeks. This is why cannabinoids can be detected in drug tests long after the psychoactive effects have worn out.
- **Blood-brain barrier**: THC crosses the BBB rapidly (within seconds to minutes of inhalation) via passive diffusion due to its high lipophilicity.
- **Protein binding**: THC is approximately 97% bound to plasma proteins (primarily lipoproteins and albumin), meaning only ~3% is "free" and pharmacologically active at any given time.
- **Redistribution**: After initial brain uptake, THC redistributes from the brain to fatty tissues, which is why the psychoactive effects of a single dose peak quickly and then decline even though the drug is still present in the body.
...
- **Clozapine** (antipsychotic): Smoking may reduce blood levels by 20-40%
- **Olanzapine** (antipsychotic): Similar effect
- **Theophylline** (asthma): Reduced effectiveness
- **Warfarin**: CYP1A2 induction may increase R-warfarin metabolism (though S-warfarin, the more potent enantiomer, is metabolized by CYP2C9)
...
1. **Desensitization** (minutes to hours): After THC activates a CB1 receptor, the receptor is **phosphorylated** by G protein-coupled receptor kinases (GRKs). This phosphorylation prevents the receptor from signaling, effectively "turning it off" even though it is still present on the cell surface.

2. **Internalization** (hours to days): Desensitized CB1 receptors are **endocytosed** (pulled inside the cell) into intracellular vesicles. They are no longer available on the cell surface to receive signals from endocannabinoids or THC.

3. **Downregulation** (days to weeks): If THC exposure continues, internalized CB1 receptors are **degraded** (broken down by lysosomes) rather than being recycled back to the surface. The total number of CB1 receptors in the brain decreases.

4. **Reduced receptor expression** (weeks): Chronic THC exposure may also reduce the **gene expression** of CB1 receptors, meaning the cell produces fewer new receptors to replace the ones being degraded.
...
- **Frequency and duration of use**: Daily, multi-year users experience more severe withdrawal.
- **Potency of cannabis used**: Higher-THC products are associated with more significant withdrawal.
- **Individual factors**: Genetics, mental health status, and social support all influence withdrawal severity.

### Tolerance Management

For patients using cannabis medically, tolerance management is an important consideration:

- **Tolerance breaks (T-breaks)**: A period of abstinence (typically 2-4 weeks) allows CB1 receptors to reset. Even shorter breaks (48-72 hours) can partially restore sensitivity.
- **THC:CBD ratios**: Products with higher CBD content may slow tolerance development, as CBD's negative allosteric modulation at CB1 may partially counteract the receptor downregulation caused by THC.
- **Dose optimization**: Using the minimum effective dose reduces the rate of tolerance development.
- **Rotating consumption methods**: Alternating between inhalation (rapid onset, short duration) and oral (slower onset, longer duration) may help reduce overall daily THC exposure while maintaining symptom relief.
...
- Impaired driving ability (reaction time and motor coordination affected)
- In adolescents: potential impact on developing brain (research ongoing)
...
- **Negative allosteric modulator of CB1**: Alters the receptor's shape, reducing THC's binding efficiency (which is why CBD can moderate THC's psychoactive effects)
- **5-HT1A receptor agonist**: Serotonin receptor interaction linked to anti-anxiety effects
- **TRPV1 agonist**: Vanilloid receptor involved in pain perception and inflammation
- **GPR55 antagonist**: May contribute to anti-cancer and bone-density effects
- **FAAH inhibitor**: Increases anandamide levels by preventing its breakdown
...
### THCA and CBDA (Acidic Precursors)
...
- **THCA**: Potential anti-inflammatory, anti-nausea, and neuroprotective properties; may inhibit COX-1 and COX-2 enzymes (similar to NSAIDs)
- **CBDA**: Potent anti-nausea and anti-anxiety effects (some studies suggest CBDA may be more potent than CBD for nausea); potential anti-breast-cancer activity in vitro
- **Raw cannabis consumption**: Juicing raw cannabis leaves and flower provides acidic cannabinoids without psychoactive effects, though clinical evidence for benefits is limited
...
- **Residual solvents**: Incomplete purification may leave acids and chemical byproducts in the final product
- **Unknown byproducts**: The isomerization process can produce various compounds that may not be tested for or disclosed
- **Lack of regulation**: In unregulated markets, products may contain inconsistent Delta-8 levels or contaminants
- **Mislabeling**: Studies have found significant discrepancies between labeled and actual Delta-8 content in commercial products
...
- **Sativex** (THC:CBD 1:1 spray) is more effective for multiple sclerosis spasticity than THC alone
- **Epidiolex** (pure CBD) shows a bell-shaped dose-response, but full-spectrum extracts may have wider therapeutic windows
- Clinical observations consistently report that many patients prefer full-spectrum products over isolates, even at lower cannabinoid concentrations
...
For more on how terpenes contribute to the entourage effect, see [Terpenes & the Entourage Effect](/science/terpenes).

---

## How Cannabinoid Profiles Vary by Strain
...
- **Genetics**: The cultivar's inherited enzyme pathways determine which cannabinoids it primarily produces
- **Growing conditions**: Light, temperature, nutrients, and stress affect cannabinoid production
...
1. **Verify the lab**: Ensure the testing laboratory is accredited and independent (not affiliated with the producer)
2. **Check batch/lot numbers**: Match the COA to your specific product batch
3. **Verify potency matches the label**: Total THC = THCA × 0.877 + Delta-9-THC (the 0.877 factor accounts for CO2 loss during decarboxylation)
4. **Review contaminant results**: All values should be below regulatory limits
5. **Look for "Pass" or "Compliant"**: The overall result should indicate the product meets safety standards
...
## Consumption Methods and Cannabinoid Bioavailability
...
1. Mechoulam, R., & Gaoni, Y. (1965). Hashish -- XI. On the nature of the cannabinol transformation. *Tetrahedron*, 21(5), 1223-1229.
2. Mechoulam, R., & Ben-Shabat, S. (1998). An entourage effect: inactive endogenous fatty acid glycerol esters enhance 2-arachidonoyl-glycerol cannabinoidal activity. *European Journal of Pharmacology*, 359(1), R1-R2.
3. Pertwee, R. G. (2008). The diverse CB1 and CB2 receptor pharmacology of three plant cannabinoids: Delta-9-tetrahydrocannabinol, cannabidiol and Delta-9-tetrahydrocannabivarin. *British Journal of Pharmacology*, 153(2), 199-215.
4. Devinsky, O., et al. (2017). Trial of cannabidiol for drug-resistant seizures in the Dravet syndrome. *New England Journal of Medicine*, 376(21), 2011-2020.
...
8. Borgelt, L. M., et al. (2013). The pharmacologic and clinical effects of medical cannabis. *Pharmacotherapy*, 33(2), 195-209.
9. Citti, C., et al. (2019). A novel phytocannabinoid isolated from Cannabis sativa L. with an in vivo cannabimimetic activity higher than Delta-9-tetrahydrocannabinol: Delta-9-tetrahydrocannabiphorol. *Scientific Reports*, 9, 20335.
10. World Health Organization. (2018). *Cannabidiol (CBD) Critical Review Report*. Expert Committee on Drug Dependence.
11. Devane, W. A., Hanus, L., Breuer, A., Pertwee, R. G., Stevenson, L. A., Griffin, G., ... & Mechoulam, R. (1992). Isolation and structure of a brain constituent that binds to the cannabinoid receptor. *Science*, 258(5090), 1946-1949.
12. Stella, N., Schweitzer, P., & Piomelli, D. (1997). A second endogenous cannabinoid that modulates long-term potentiation. *Nature*, 388(6644), 773-778.
13. Hirvonen, J., et al. (2016). Reversible and regionally selective downregulation of brain cannabinoid CB1 receptors in chronic daily cannabis smokers. *Molecular Psychiatry*, 17(6), 642-649.
14. Huestis, M. A. (2007). Human cannabinoid pharmacokinetics. *Chemistry & Biodiversity*, 4(8), 1770-1804.
15. D'Addario, C., et al. (2021). Epigenetic mechanisms in the endocannabinoid system: New therapeutic opportunities? *Pharmacological Research*, 163, 105295.
16. Allsop, D. J., et al. (2014). Cannabinoid withdrawal in cannabis users: A systematic review of the literature. *Current Drug Abuse Reviews*, 7(1), 46-62.
17. Crippa, J. A., et al. (2019). Transdermal cannabidiol reduces inflammation and pain-related behaviours in a rat model of arthritis. *European Journal of Pain*, 23(1), 136-147.
18. Klein, C., et al. (2017). Pharmacokinetics and pharmacodynamics of cannabinoids. *Clinical Pharmacokinetics*, 56(8), 825-842.
