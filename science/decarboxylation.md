...
# Decarboxylation: Activating Cannabis Compounds
...
### All Major Acidic Cannabinoids Decarboxylate
...
- **Higher temperatures = faster decarboxylation** (but also faster terpene loss and potential THC→CBN degradation)
- **Lower temperatures = slower, more controlled decarboxylation** (better terpene preservation)
- The reaction is **never 100% complete** — some THCA always remains, and some THC always degrades to CBN
- Optimal decarboxylation balances **conversion efficiency** with **compound preservation**

---

## Why Decarboxylation Matters

### For Edibles and Oral Consumption
...
- Edibles made from raw flower produce **minimal psychoactive effects**
- Tinctures may have therapeutic value (from acidic cannabinoids) but will not produce the expected THC effects
- Dosing becomes **highly unpredictable**

### For Extraction Workflows

Many extraction methods produce concentrates that are still in acidic form:
- **Rosin** from raw flower contains THCA
- **Ice-water hash** contains THCA
- **Dry sift/kief** contains THCA
- **Ethanol extracts** (unless specifically decarbed during processing) contain THCA
- **CO₂ extracts** may be partially decarbed depending on process parameters
...
- Acidic cannabinoids release CO₂ gas when heated during distillation, causing **foaming and "bumping"** that disrupts the process
- THCA and THC have **different boiling points**, making fractional separation impossible if both are present
- Equipment designed for neutral cannabinoids is not sized for gas evolution from decarboxylation
...
- Grinder or scissors
- Airtight container (for storage after decarb)

**Step-by-step:**

1. **Preheat oven** to target temperature (see table below)
2. **Grind cannabis** to a coarse, consistent particle size (~3-5mm). Too fine = faster degradation; too coarse = uneven decarb
3. **Spread evenly** on parchment-lined baking sheet in a thin, uniform layer
4. **Place in oven** and set timer
5. **Optional:** Stir gently halfway through for more even heating
6. **Remove and cool** — the material should be light brown/golden, not burnt
7. **Store immediately** in an airtight container to minimize oxidation
...
- **Convection ovens** circulate air, producing more even heating and slightly faster decarboxylation. Reduce time by ~5 minutes compared to conventional oven times.
- **Conventional ovens** may have hot spots. Use an oven thermometer to verify actual temperature and rotate the tray halfway through.

### Mason Jar Method (Reduced Odor)

For those concerned about the strong odor of decarboxylation:

1. Place ground cannabis in a **heat-safe mason jar** (do not seal tightly — pressure buildup risk)
2. Place jar on baking sheet in preheated oven
3. Follow the same time/temperature guidelines above
4. The jar contains most of the odor while still allowing CO₂ to escape
...
### Concentrate Decarboxylation Reference Table
...
## The Decarboxylation-Terpene Tradeoff
...
### Terpene Boiling Points vs. Decarb Temperatures
...
1. **Two-stage decarboxylation:** Start at a lower temperature (200°F for 30 min) to gently begin conversion while preserving volatiles, then increase to 220°F for 15-20 min to complete conversion.

2. **Capture evaporated terpenes:** Place the baking sheet inside a larger tray with a loose foil cover. Some evaporated terpenes will condense on the foil and can be collected.

3. **Decarb for purpose:** Edibles where flavor will be masked (chocolate, brownies) don't need maximum terpene retention. Tinctures and sublingual products benefit from higher terpene preservation.

---

## Monitoring Decarboxylation Progress

### Laboratory Methods

Professional processors measure decarboxylation completion using:

- **HPLC (High-Performance Liquid Chromatography)** — Separates and quantifies THCA, THC, and other cannabinoids. The gold standard for accuracy.
- **Decarboxylation ratio calculation:** THC ÷ (THCA × 0.877 + THC) × 100 = % decarbed
...
## Decarboxylation and Specific End Products
...
- **Partial decarboxylation** may be desirable if you want a mix of active THC and acidic THCA (some patients seek specific THCA:THC ratios)
- Alcohol-based tinctures decarboxylate *slowly* over weeks/months at room temperature — some producers rely on this natural process
- For immediate results, apply heat before tincture preparation

### For Distillation

- **Full decarboxylation is mandatory** before short-path or wiped-film distillation
- Incomplete decarb causes foaming, bumping, and equipment issues
- Distillers typically decarb at higher temperatures (240-260°F) since terpene preservation is not a concern at this stage (terpenes are stripped during distillation anyway)
...
## Quick Reference: Decarbing Cheat Sheet
