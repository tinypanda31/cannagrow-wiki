...
At the core of cannabis's effects on the human body is the **endocannabinoid system** — a vast network of receptors, signaling molecules, and enzymes found throughout the brain, organs, connective tissues, and immune cells.
...
The endocannabinoid system is involved in maintaining **homeostasis** — the body's effort to keep internal conditions stable despite external changes. It influences:

- **Mood and emotion** — anxiety, depression, stress response
- **Pain perception** — acute, chronic, and neuropathic pain
- **Appetite and metabolism** — hunger signals, energy balance
- **Sleep** — sleep onset, quality, and circadian regulation
- **Memory and learning** — short-term memory, synaptic plasticity, fear extinction
- **Immune function** — inflammation, autoimmune responses
- **Reproduction** — fertility, embryo implantation
- **Temperature regulation** — body temperature homeostasis
- **Motor control** — movement coordination (cerebellum has high CB1 density)

### How Plant Cannabinoids Interact with the ECS

Phytocannabinoids (plant-derived cannabinoids like THC and CBD) interact with the ECS because they are structurally similar to the body's own endocannabinoids. This is a rare occurrence — relatively few plants produce compounds that directly activate human receptors.

- **THC** mimics anandamide, binding to CB1 receptors with high affinity, producing psychoactive effects.
- **CBD** does not directly activate CB1 or CB2 but modulates receptor activity and influences how THC binds, among dozens of other mechanisms.
- **Beta-caryophyllene** (a terpene) uniquely binds directly to CB2 receptors — the only known dietary terpene to do so.

---

## Cannabinoids: The Chemistry of Cannabis Effects
...
|-------------|-----------|:------------:|--------------------------|---------------------|
| **Δ9-THC** | Delta-9-tetrahydrocannabinol | Yes | CB1 agonist (high affinity), CB2 agonist | Primary psychoactive compound; pain relief; appetite stimulation |
| **Δ8-THC** | Delta-8-tetrahydrocannabinol | Mild | CB1 agonist (lower affinity than Δ9) | ~50-75% potency of Δ9; more stable; semi-synthetic in most products |
...
- **CBGA** (cannabigerolic acid) is the "mother cannabinoid" from which THCA, CBDA, and CBCA are synthesized by specific enzymes in the plant's trichomes.
...
For decades, cannabis was classified simply as indica or sativa, with effects attributed to subspecies differences. Modern research reveals that **terpene and cannabinoid profiles — not subspecies classification — determine the experiential effects of any given strain**.

Terpenes affect the cannabis experience through several mechanisms:

1. **Direct pharmacological activity** — Some terpenes activate receptors (e.g., beta-caryophyllene activates CB2 receptors; linalool interacts with GABA receptors).
2. **Modulation of cannabinoid activity** — Terpenes can influence how cannabinoids interact with receptors, potentially affecting absorption, blood-brain barrier permeability, and receptor binding.
3. **Intrinsic psychoactive effects** — Inhaled terpenes have documented anxiolytic, sedating, and stimulating properties independent of cannabinoids.
4. **The entourage effect** — The combined activity of cannabinoids, terpenes, and other plant compounds produces effects greater than the sum of individual components.

### Key Cannabis Terpenes

| Terpene | Aroma | Found In | Documented Effects | Boiling Point |
|---------|-------|----------|-------------------|---------------|
| **Myrcene** | Earthy, musky, clove-like | Hops, mangoes, thyme | Relaxing, sedating, muscle relaxant | 167°C (332°F) |
| **Limonene** | Citrus, lemon, orange | Citrus rinds, juniper | Uplifting, mood-elevating, anti-anxiety | 177°C (350°F) |
| **Beta-Caryophyllene** | Peppery, spicy, woody | Black pepper, cloves, hops | Anti-inflammatory, CB2 activation, analgesic | 130°C (266°F) |
| **Pinene** (α/β) | Pine, fresh, herbal | Pine needles, rosemary, sage | Alertness, memory retention, bronchodilator | 155°C (311°F) |
| **Linalool** | Floral, lavender, sweet | Lavender, mint, coriander | Calming, anti-anxiety, potential anti-seizure | 198°C (388°F) |
| **Terpinolene** | Herbal, floral, citrus | Nutmeg, tea tree, cumin | Mixed effects (sedating or stimulating), antioxidant | 184°C (363°F) |
| **Humulene** | Earthy, hoppy, woody | Hops, coriander, ginseng | Appetite suppressant, anti-inflammatory, antibacterial | 113°C (235°F) |

### Terpene Preservation

Terpenes are delicate and easily degraded by:

- **Heat** during drying, curing, or extraction
- **Light** exposure (UV degrades terpenes rapidly)
- **Oxygen** exposure (oxidation alters terpene profiles)
- **Time** (terpenes evaporate and degrade during storage)
...
The **entourage effect** is the theory that the full spectrum of cannabis compounds — cannabinoids, terpenes, flavonoids, and others — work together synergistically to produce effects that differ from and exceed the effects of any individual isolated compound.
...
- **Limited clinical trials** — Most evidence is preclinical (animal models, cell cultures). Large-scale human trials are still limited.
- **Dose-response complexity** — Synergistic effects may be dose-dependent and non-linear, making standardized dosing difficult.
- **Marketing vs. science** — "Entourage effect" is sometimes used as a marketing term without rigorous scientific backing.
- **Individual variation** — Genetic differences in receptor expression, metabolism, and endocannabinoid tone mean entourage effects may vary significantly between individuals.
...
## Receptor Pharmacology: How Cannabis Compounds Affect the Brain
...
1. **THC enters the bloodstream** (via inhalation, ingestion, sublingual absorption, etc.)
2. **THC crosses the blood-brain barrier** (it is highly lipid-soluble)
3. **THC binds to CB1 receptors** as a **partial agonist** — it activates the receptor but not to its full potential
4. **CB1 activation inhibits neurotransmitter release** — CB1 receptors are presynaptic, meaning they regulate the release of other neurotransmitters
5. **Downstream effects** include:
   - **Dopamine release** in the nucleus accumbens → euphoria, reward
   - **GABA modulation** in the amygdala → altered anxiety response
   - **Glutamate inhibition** in the hippocampus → memory impairment
   - **Serotonin modulation** → mood changes, altered perception
...
| Mechanism | Effect |
|-----------|--------|
| **Negative allosteric modulator of CB1** | Changes the shape of the CB1 receptor, making it harder for THC to bind — *reduces THC's psychoactivity* |
| **5-HT1A receptor agonist** | Activates serotonin receptors → anti-anxiety, anti-depressant effects |
| **TRPV1 receptor agonist** | Activates vanilloid receptors → pain relief, anti-inflammatory |
| **FAAH inhibitor** | Slows breakdown of anandamide → elevated endocannabinoid levels |
| **GPR55 antagonist** | Blocks orphan receptor GPR55 → potential anti-cancer, anti-inflammatory |
| **Adenosine reuptake inhibitor** | Increases adenosine → anti-inflammatory, cardiovascular protection |
...
## Onset of Effects by Route of Administration
...
|-------|-------|------|----------|:-------------:|---------------|
| **Inhalation (smoking/vaping)** | 1-5 min | 10-30 min | 1-3 hours | 25-50% | Direct lung absorption → bloodstream → brain |
| **Sublingual (tinctures)** | 15-45 min | 1-2 hours | 4-6 hours | 15-35% | Mucous membrane absorption → bloodstream |
| **Ingestion (edibles)** | 30 min - 2 hours | 2-4 hours | 4-12 hours | 10-20% | Liver metabolism: THC → **11-hydroxy-THC** (more potent) |
| **Topical** | 15-45 min | 1-2 hours | 2-8 hours | Variable (local) | Skin absorption → localized cannabinoid receptor activation |
| **Transdermal patch** | 30-60 min | 2-6 hours | 8-72 hours | High (systemic) | Crosses skin barrier → sustained bloodstream delivery |
...
## Individual Variation: Why Cannabis Affects Everyone Differently
...
| **Tolerance** | Chronic THC use causes CB1 receptor downregulation — reduced sensitivity requiring higher doses |
...
- **Project CBD** (projectcbd.org) — CBD research and education
- **NORML** (norml.org) — Cannabis policy and science
- **PubMed** — Search "cannabinoid" or "endocannabinoid" for peer-reviewed research
