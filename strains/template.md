---
title: Strain Template Guide
description: How to read and interpret the standard strain pages in the CannaGrow strain database.
---
...
**What to look for:**
- Whether the strain is a landrace (naturally occurring in a specific geographic region) or a bred hybrid
- The geographic origin or breeding program that developed the strain
- Any notable historical significance or cultural impact
...
- **Landrace strains** -- Naturally occurring populations adapted to a specific geographic region over many generations without intentional human breeding (e.g., Afghani, Durban Poison, Hindu Kush)
- **First-generation hybrids** -- Early crosses between landrace strains, often developed in the 1970s-1990s
- **Modern hybrids** -- Multi-generation crosses involving previously hybridized parents
...
- **Accurate potency data** for the specific batch being tested
- **Safety screening** for pesticides, heavy metals, microbes, and residual solvents
- **Terpene profiles** showing the actual terpene concentrations

Always prioritize a current COA over wiki ranges when evaluating a specific product.

### Limitations of Reported Numbers

- **Ranges represent typical values, not guaranteed boundaries.** Some samples may fall outside the stated range.
- **Testing methodology matters.** Different labs using different equipment and protocols may report different values for the same sample.
- **Age and storage affect potency.** THC degrades to CBN over time, especially with heat, light, and oxygen exposure.
- **Growing conditions are the largest variable.** Nutrient regimen, light spectrum, temperature, humidity, harvest timing, and curing all significantly affect the final cannabinoid and terpene profile.

### How Growing Conditions Affect the Final Product
...
## Using the Template for Research

1. **Compare strains** -- Use the Quick Stats tables on each strain page to compare cannabinoid content and growing characteristics side by side.
2. **Identify patterns** -- Look for recurring terpenes across strains with similar effects to understand the entourage effect.
3. **Select growing candidates** -- Use the Growing Information section to match strains to your experience level and growing environment.
4. **Cross-reference parentage** -- Follow genetic lineage links to understand how parent strain characteristics carry into their offspring.
